...
require 'google2/apis/core/multipart'
  ...
  module Apis
    module Core
      ...
      class UploadIO < Hurley::UploadIO
        ...
        # @return [Google2::Apis::Core::UploadIO]
      ...
      class BaseUploadCommand < ApiCommand
        ...
        # Ensure the content is readable and wrapped in an {{Google2::Apis::Core::UploadIO}} instance.
        #
        # @return [void]
        # @raise [Google2::Apis::ClientError] if upload source is invalid
        def prepare!
          super
          if streamable?(upload_source)
            ...
            fail Google2::Apis::ClientError, 'Invalid upload source'
          end
        end
      ...
      class ResumableUploadCommand < BaseUploadCommand
        ...
        def process_response(status, header, body)
          ...
          if upload_status == STATUS_ACTIVE
            ...
            @state = :cancelled
            fail Google2::Apis::ClientError, body
          end
        ...
        # @raise [Google2::Apis::ServerError] Unable to send the request
        def send_start_command(client)
          ...
          raise Google2::Apis::ServerError, e.message
        end
