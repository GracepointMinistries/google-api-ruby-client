  ...
  module Apis
    module Core
      ...
      class FilePart
        ...
        # @param [String] boundary
        #   Multipart boundary
        # @param [Google2::Apis::Core::UploadIO] io
        #   IO stream
        # @param [Hash] header
        #   Additional headers
...
\r
      ...
      class Multipart
        ...
        def add_json(body, content_id: nil)
          ...
          @parts << Google2::Apis::Core::JsonPart.new(@boundary, body, header)
          self
        end

        # Append arbitrary data as a part
        #
        # @param [Google2::Apis::Core::UploadIO] upload_io
        #   IO stream
        # @param [String] content_id
        #   Optional unique ID of this part
        # @return [self]
        def add_upload(upload_io, content_id: nil)
          header = { :content_id => content_id }
          @parts << Google2::Apis::Core::FilePart.new(@boundary,
                                                     upload_io,
                                                     header)
          self
        end
