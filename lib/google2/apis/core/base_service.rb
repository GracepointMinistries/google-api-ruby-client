  ...
  module Apis
    module Core
      ...
      class BaseService
        ...
        # General settings
        # @return [Google2::Apis::ClientOptions]
        attr_accessor :client_options

        # Default options for all requests
        # @return [Google2::Apis::RequestOptions]
        ...
        def initialize(root_url, base_path)
          ...
          self.client_options = Google2::Apis::ClientOptions.default.dup
          self.request_options = Google2::Apis::RequestOptions.default.dup
        end
        ...
        #   end
        #
        # @param [Hash, Google2::Apis::RequestOptions] options
        ...
        # @param [Hash, Google2::Apis::RequestOptions] options
        #  Request-specific options
        # @return [Google2::Apis::Core::UploadCommand]
        ...
        # @param [Hash, Google2::Apis::RequestOptions] options
        #  Request-specific options
        # @return [Google2::Apis::Core::DownloadCommand]
        ...
        #
        # @param [Google2::Apis::Core::HttpCommand] command
        #   Command to execute
        ...
        # @param [Google2::Apis::Core::HttpCommand] _command
        ...
        def new_client
          ...
          client.connection = Google2::Apis::Core::HttpClientAdapter.new unless client_options.use_net_http
          ...
          client.ssl_options.ca_file = File.join(Google2::Apis::ROOT, 'lib', 'cacerts.pem')
        ...
        def user_agent
          sprintf('%s/%s google-api-ruby-client/%s %s (gzip)',
                  ...
                  Google2::Apis::VERSION,
                  Google2::Apis::OS_VERSION)
        end
      end
    end
  end
