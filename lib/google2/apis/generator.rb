...
require 'google2/apis/generator/annotator'
require 'google2/apis/generator/model'
require 'google2/apis/generator/template'
...
module Google2
  module Apis
    ...
    # @private
    class Generator
      Discovery = Google2::Apis::DiscoveryV1

      # Load templates
      def initialize(api_names: nil)
        @names = Google2::Apis::Generator::Names.new(api_names || File.join(Google2::Apis::ROOT, 'api_names.yaml'))
