...
module Google2
  module Apis
    module CloudmonitoringV2beta2
      ...
      #
      # @example
      #    require 'google2/apis/cloudmonitoring_v2beta2'
      #
      #    Cloudmonitoring = Google2::Apis::CloudmonitoringV2beta2 # Alias the module
      #    service = Cloudmonitoring::CloudMonitoringService.new
      #
      # @see https://cloud.google.com/monitoring/v2beta2/
      class CloudMonitoringService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        #   project name.
        # @param [Google2::Apis::CloudmonitoringV2beta2::MetricDescriptor] metric_descriptor_object
        # @param [String] fields
        ...
        # @yieldparam result [Google2::Apis::CloudmonitoringV2beta2::MetricDescriptor] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CloudmonitoringV2beta2::MetricDescriptor]
        #
        ...
        def create_metric_descriptor(project, metric_descriptor_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::CloudmonitoringV2beta2::MetricDescriptor::Representation
          command.request_object = metric_descriptor_object
          command.response_representation = Google2::Apis::CloudmonitoringV2beta2::MetricDescriptor::Representation
          command.response_class = Google2::Apis::CloudmonitoringV2beta2::MetricDescriptor
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CloudmonitoringV2beta2::DeleteMetricDescriptorResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CloudmonitoringV2beta2::DeleteMetricDescriptorResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def delete_metric_descriptor(project, metric, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::CloudmonitoringV2beta2::DeleteMetricDescriptorResponse::Representation
          command.response_class = Google2::Apis::CloudmonitoringV2beta2::DeleteMetricDescriptorResponse
          command.params['project'] = project unless project.nil?
        ...
        #   The project id. The value can be the numeric project ID or string-based
        #   project name.
        # @param [Google2::Apis::CloudmonitoringV2beta2::ListMetricDescriptorsRequest] list_metric_descriptors_request_object
        # @param [Fixnum] count
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CloudmonitoringV2beta2::ListMetricDescriptorsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CloudmonitoringV2beta2::ListMetricDescriptorsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_metric_descriptors(project, list_metric_descriptors_request_object = nil, count: nil, page_token: nil, query: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::CloudmonitoringV2beta2::ListMetricDescriptorsRequest::Representation
          command.request_object = list_metric_descriptors_request_object
          command.response_representation = Google2::Apis::CloudmonitoringV2beta2::ListMetricDescriptorsResponse::Representation
          command.response_class = Google2::Apis::CloudmonitoringV2beta2::ListMetricDescriptorsResponse
          command.params['project'] = project unless project.nil?
        ...
        #   timestamp.
        # @param [Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesRequest] list_timeseries_request_object
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_timeseries(project, metric, youngest, list_timeseries_request_object = nil, aggregator: nil, count: nil, labels: nil, oldest: nil, page_token: nil, timespan: nil, window: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesRequest::Representation
          command.request_object = list_timeseries_request_object
          command.response_representation = Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesResponse::Representation
          command.response_class = Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesResponse
          command.params['project'] = project unless project.nil?
          command.params['metric'] = metric unless metric.nil?
        ...
        #   The project ID. The value can be the numeric project ID or string-based
        #   project name.
        # @param [Google2::Apis::CloudmonitoringV2beta2::WriteTimeseriesRequest] write_timeseries_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CloudmonitoringV2beta2::WriteTimeseriesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CloudmonitoringV2beta2::WriteTimeseriesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def write_timeseries(project, write_timeseries_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::CloudmonitoringV2beta2::WriteTimeseriesRequest::Representation
          command.request_object = write_timeseries_request_object
          command.response_representation = Google2::Apis::CloudmonitoringV2beta2::WriteTimeseriesResponse::Representation
          command.response_class = Google2::Apis::CloudmonitoringV2beta2::WriteTimeseriesResponse
          command.params['project'] = project unless project.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #   End of the time interval (inclusive), which is expressed as an RFC 3339
        #   timestamp.
        # @param [Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesDescriptorsRequest] list_timeseries_descriptors_request_object
        # @param [String] aggregator
        #   The aggregation function that will reduce the data points in each window to a
        #   single point. This parameter is only valid for non-cumulative metrics with a
        #   value type of INT64 or DOUBLE.
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesDescriptorsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesDescriptorsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_timeseries_descriptors(project, metric, youngest, list_timeseries_descriptors_request_object = nil, aggregator: nil, count: nil, labels: nil, oldest: nil, page_token: nil, timespan: nil, window: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesDescriptorsRequest::Representation
          command.request_object = list_timeseries_descriptors_request_object
          command.response_representation = Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesDescriptorsResponse::Representation
          command.response_class = Google2::Apis::CloudmonitoringV2beta2::ListTimeseriesDescriptorsResponse
          command.params['project'] = project unless project.nil?
          command.params['metric'] = metric unless metric.nil?
          command.query['aggregator'] = aggregator unless aggregator.nil?
          command.query['count'] = count unless count.nil?
