  ...
  module Apis
    module AndroidenterpriseV1
      ...
      class AppRestrictionsSchema
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::AppRestrictionsSchemaRestriction>]
      ...
      class AppRestrictionsSchemaRestriction
        ...
        # @return [Google2::Apis::AndroidenterpriseV1::AppRestrictionsSchemaRestrictionRestrictionValue]
      ...
      class ListCollectionViewersResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::User>]
        attr_accessor :user
      ...
      class ListCollectionsResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::Collection>]
      ...
      class ListDevicesResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::Device>]
      ...
      class ListEnterprisesResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::Enterprise>]
      ...
      class ListEntitlementsResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::Entitlement>]
      ...
      class ListGroupLicensesResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::GroupLicense>]
      ...
      class ListInstallsResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::Install>]
      ...
      class Product
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::AppVersion>]
      ...
      class ProductPermissions
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::ProductPermission>]
      ...
      class ApproveProductRequest
        ...
        # @return [Google2::Apis::AndroidenterpriseV1::ApprovalUrlInfo]
      ...
      class ProductsListResponse
        ...
        # @return [Google2::Apis::AndroidenterpriseV1::PageInfo]
        attr_accessor :page_info
      
        # Information about a product (e.g. an app) in the Google Play Store, for
        # display to an enterprise admin.
        # Corresponds to the JSON property `product`
        # @return [Array<Google2::Apis::AndroidenterpriseV1::Product>]
        attr_accessor :product
      
        # Pagination information for token pagination.
        # Corresponds to the JSON property `tokenPagination`
        # @return [Google2::Apis::AndroidenterpriseV1::TokenPagination]
      ...
      class StoreCluster
        ...
        # Corresponds to the JSON property `name`
        # @return [Array<Google2::Apis::AndroidenterpriseV1::LocalizedText>]
        attr_accessor :name
      ...
      class StoreLayoutClustersListResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::StoreCluster>]
      ...
      class StoreLayoutPagesListResponse
        ...
        # @return [Array<Google2::Apis::AndroidenterpriseV1::StorePage>]
        attr_accessor :page
