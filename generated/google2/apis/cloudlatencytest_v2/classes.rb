  ...
  module Apis
    module CloudlatencytestV2
      ...
      class AggregatedStats
        ...
        # @return [Array<Google2::Apis::CloudlatencytestV2::Stats>]
        attr_accessor :stats
      ...
      class Stats
        ...
        # @return [Array<Google2::Apis::CloudlatencytestV2::DoubleValue>]
        attr_accessor :double_values
      
        # 
        # Corresponds to the JSON property `intValues`
        # @return [Array<Google2::Apis::CloudlatencytestV2::IntValue>]
        attr_accessor :int_values
      
        # 
        # Corresponds to the JSON property `stringValues`
        # @return [Array<Google2::Apis::CloudlatencytestV2::StringValue>]
