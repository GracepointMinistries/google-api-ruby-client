  ...
  module Apis
    module SiteVerificationV1
      ...
      class GetWebResourceTokenRequest
        ...
        # @return [Google2::Apis::SiteVerificationV1::GetWebResourceTokenRequest::Site]
        attr_accessor :site
      ...
      class ListWebResourceResponse
        ...
        # @return [Array<Google2::Apis::SiteVerificationV1::SiteVerificationWebResourceResource>]
        attr_accessor :items
      ...
      class SiteVerificationWebResourceResource
        ...
        # Corresponds to the JSON property `site`
        # @return [Google2::Apis::SiteVerificationV1::SiteVerificationWebResourceResource::Site]
        attr_accessor :site
