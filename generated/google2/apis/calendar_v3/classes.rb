  ...
  module Apis
    module CalendarV3
      ...
      class Acl
        ...
        # @return [Array<Google2::Apis::CalendarV3::AclRule>]
        attr_accessor :items
      ...
      class AclRule
        ...
        # @return [Google2::Apis::CalendarV3::AclRule::Scope]
        attr_accessor :scope
      ...
      class CalendarList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CalendarV3::CalendarListEntry>]
        attr_accessor :items
      ...
      class CalendarListEntry
        ...
        # @return [Array<Google2::Apis::CalendarV3::EventReminder>]
        ...
        # @return [Google2::Apis::CalendarV3::CalendarListEntry::NotificationSettings]
        ...
        class NotificationSettings
          ...
          # @return [Array<Google2::Apis::CalendarV3::CalendarNotification>]
      ...
      class Colors
        ...
        # @return [Hash<String,Google2::Apis::CalendarV3::ColorDefinition>]
      ...
      class Event
        ...
        # @return [Array<Google2::Apis::CalendarV3::EventAttachment>]
        ...
        # @return [Array<Google2::Apis::CalendarV3::EventAttendee>]
        ...
        # @return [Google2::Apis::CalendarV3::Event::Creator]
        ...
        # @return [Google2::Apis::CalendarV3::EventDateTime]
        attr_accessor :end
        ...
        # @return [Google2::Apis::CalendarV3::Event::ExtendedProperties]
        attr_accessor :extended_properties
      
        # A gadget that extends this event.
        # Corresponds to the JSON property `gadget`
        # @return [Google2::Apis::CalendarV3::Event::Gadget]
        ...
        # @return [Google2::Apis::CalendarV3::Event::Organizer]
        ...
        # @return [Google2::Apis::CalendarV3::Event::Reminders]
        ...
        # @return [Google2::Apis::CalendarV3::Event::Source]
      ...
      class Events
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CalendarV3::Event>]
        attr_accessor :items
      ...
      class FreeBusyCalendar
        ...
        # @return [Array<Google2::Apis::CalendarV3::TimePeriod>]
        attr_accessor :busy
      
        # Optional error(s) (if computation for the calendar failed).
        # Corresponds to the JSON property `errors`
        # @return [Array<Google2::Apis::CalendarV3::Error>]
      ...
      class FreeBusyRequest
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CalendarV3::FreeBusyRequestItem>]
        attr_accessor :items
      ...
      class FreeBusyResponse
        ...
        # Corresponds to the JSON property `calendars`
        # @return [Hash<String,Google2::Apis::CalendarV3::FreeBusyCalendar>]
        attr_accessor :calendars
      
        # Expansion of groups.
        # Corresponds to the JSON property `groups`
        # @return [Hash<String,Google2::Apis::CalendarV3::FreeBusyGroup>]
      ...
      class Settings
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CalendarV3::Setting>]
        attr_accessor :items
