    ...
    module DoubleclicksearchV2
      ...
      class Conversion
        ...
        class Representation < Google2::Apis::Core::JsonRepresentation
          ...
          collection :custom_dimension, as: 'customDimension', class: Google2::Apis::DoubleclicksearchV2::CustomDimension, decorator: Google2::Apis::DoubleclicksearchV2::CustomDimension::Representation
      
          collection :custom_metric, as: 'customMetric', class: Google2::Apis::DoubleclicksearchV2::CustomMetric, decorator: Google2::Apis::DoubleclicksearchV2::CustomMetric::Representation
      ...
      class ConversionList
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :conversion, as: 'conversion', class: Google2::Apis::DoubleclicksearchV2::Conversion, decorator: Google2::Apis::DoubleclicksearchV2::Conversion::Representation
      ...
      class Report
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :files, as: 'files', class: Google2::Apis::DoubleclicksearchV2::Report::File, decorator: Google2::Apis::DoubleclicksearchV2::Report::File::Representation
      
          property :id, as: 'id'
          property :is_report_ready, as: 'isReportReady'
          property :kind, as: 'kind'
          property :request, as: 'request', class: Google2::Apis::DoubleclicksearchV2::ReportRequest, decorator: Google2::Apis::DoubleclicksearchV2::ReportRequest::Representation
      ...
      class ReportRequest
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :columns, as: 'columns', class: Google2::Apis::DoubleclicksearchV2::ReportApiColumnSpec, decorator: Google2::Apis::DoubleclicksearchV2::ReportApiColumnSpec::Representation
      
          property :download_format, as: 'downloadFormat'
          collection :filters, as: 'filters', class: Google2::Apis::DoubleclicksearchV2::ReportRequest::Filter, decorator: Google2::Apis::DoubleclicksearchV2::ReportRequest::Filter::Representation
          ...
          collection :order_by, as: 'orderBy', class: Google2::Apis::DoubleclicksearchV2::ReportRequest::OrderBy, decorator: Google2::Apis::DoubleclicksearchV2::ReportRequest::OrderBy::Representation
      
          property :report_scope, as: 'reportScope', class: Google2::Apis::DoubleclicksearchV2::ReportRequest::ReportScope, decorator: Google2::Apis::DoubleclicksearchV2::ReportRequest::ReportScope::Representation
      
          property :report_type, as: 'reportType'
          property :row_count, as: 'rowCount'
          property :start_row, as: 'startRow'
          property :statistics_currency, as: 'statisticsCurrency'
          property :time_range, as: 'timeRange', class: Google2::Apis::DoubleclicksearchV2::ReportRequest::TimeRange, decorator: Google2::Apis::DoubleclicksearchV2::ReportRequest::TimeRange::Representation
        ...
        class Filter
          # @private
          class Representation < Google2::Apis::Core::JsonRepresentation
            property :column, as: 'column', class: Google2::Apis::DoubleclicksearchV2::ReportApiColumnSpec, decorator: Google2::Apis::DoubleclicksearchV2::ReportApiColumnSpec::Representation
      ...
      class SavedColumnList
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :items, as: 'items', class: Google2::Apis::DoubleclicksearchV2::SavedColumn, decorator: Google2::Apis::DoubleclicksearchV2::SavedColumn::Representation
      ...
      class UpdateAvailabilityRequest
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :availabilities, as: 'availabilities', class: Google2::Apis::DoubleclicksearchV2::Availability, decorator: Google2::Apis::DoubleclicksearchV2::Availability::Representation
