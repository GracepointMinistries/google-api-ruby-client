  ...
  module Apis
    module AppengineV1beta5
      ...
      class Operation
        ...
        # @return [Google2::Apis::AppengineV1beta5::Status]
        attr_accessor :error
      ...
      class ListOperationsResponse
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::Operation>]
      ...
      class Application
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::UrlDispatchRule>]
      ...
      class Version
        ...
        # @return [Google2::Apis::AppengineV1beta5::AutomaticScaling]
        ...
        # @return [Google2::Apis::AppengineV1beta5::BasicScaling]
        attr_accessor :basic_scaling
      
        # A service with manual scaling runs continuously, allowing you to perform
        # complex initialization and rely on the state of its memory over time.
        # Corresponds to the JSON property `manualScaling`
        # @return [Google2::Apis::AppengineV1beta5::ManualScaling]
        ...
        # @return [Google2::Apis::AppengineV1beta5::Network]
        attr_accessor :network
      
        # Used to specify how many machine resources an app version needs.
        # Corresponds to the JSON property `resources`
        # @return [Google2::Apis::AppengineV1beta5::Resources]
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::UrlMap>]
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::ErrorHandler>]
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::Library>]
        attr_accessor :libraries
      
        # API Serving configuration for Cloud Endpoints.
        # Corresponds to the JSON property `apiConfig`
        # @return [Google2::Apis::AppengineV1beta5::ApiConfigHandler]
        ...
        # @return [Google2::Apis::AppengineV1beta5::HealthCheck]
        ...
        # @return [Google2::Apis::AppengineV1beta5::Deployment]
      ...
      class AutomaticScaling
        ...
        # @return [Google2::Apis::AppengineV1beta5::CpuUtilization]
        ...
        # @return [Google2::Apis::AppengineV1beta5::RequestUtilization]
        ...
        # @return [Google2::Apis::AppengineV1beta5::DiskUtilization]
        ...
        # @return [Google2::Apis::AppengineV1beta5::NetworkUtilization]
      ...
      class UrlMap
        ...
        # @return [Google2::Apis::AppengineV1beta5::StaticFilesHandler]
        attr_accessor :static_files
      
        # Executes a script to handle the request that matches the URL pattern.
        # Corresponds to the JSON property `script`
        # @return [Google2::Apis::AppengineV1beta5::ScriptHandler]
        attr_accessor :script
      
        # Use Google Cloud Endpoints to handle requests.
        # Corresponds to the JSON property `apiEndpoint`
        # @return [Google2::Apis::AppengineV1beta5::ApiEndpointHandler]
      ...
      class Deployment
        ...
        # @return [Hash<String,Google2::Apis::AppengineV1beta5::FileInfo>]
        attr_accessor :files
      
        # A Docker (container) image which should be used to start the application.
        # Corresponds to the JSON property `container`
        # @return [Google2::Apis::AppengineV1beta5::ContainerInfo]
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::SourceReference>]
      ...
      class ListVersionsResponse
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::Version>]
      ...
      class Service
        ...
        # @return [Google2::Apis::AppengineV1beta5::TrafficSplit]
        attr_accessor :split
      ...
      class ListServicesResponse
        ...
        # @return [Array<Google2::Apis::AppengineV1beta5::Service>]
      ...
      class ListInstancesResponse
        ...
        # Corresponds to the JSON property `instances`
        # @return [Array<Google2::Apis::AppengineV1beta5::Instance>]
        attr_accessor :instances
