  ...
  module Apis
    module AdexchangesellerV2_0
      ...
      class Accounts
        ...
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::Account>]
        attr_accessor :items
      ...
      class AdClients
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::AdClient>]
        attr_accessor :items
      ...
      class Alerts
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::Alert>]
        attr_accessor :items
      ...
      class CustomChannel
        ...
        # @return [Google2::Apis::AdexchangesellerV2_0::CustomChannel::TargetingInfo]
      ...
      class CustomChannels
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::CustomChannel>]
        attr_accessor :items
      ...
      class Metadata
        ...
        # 
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::ReportingMetadataEntry>]
        attr_accessor :items
      ...
      class PreferredDeals
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::PreferredDeal>]
        attr_accessor :items
      ...
      class Report
        ...
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::Report::Header>]
      ...
      class SavedReports
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::SavedReport>]
        attr_accessor :items
      ...
      class UrlChannels
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdexchangesellerV2_0::UrlChannel>]
        attr_accessor :items
