...
module Google2
  module Apis
    module AppstateV1
      ...
      #
      # @example
      #    require 'google2/apis/appstate_v1'
      #
      #    Appstate = Google2::Apis::AppstateV1 # Alias the module
      #    service = Appstate::AppStateService.new
      #
      # @see https://developers.google.com/games/services/web/api/states
      class AppStateService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::AppstateV1::WriteResult] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::AppstateV1::WriteResult]
        #
        ...
        def clear_state(state_key, current_data_version: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::AppstateV1::WriteResult::Representation
          command.response_class = Google2::Apis::AppstateV1::WriteResult
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::AppstateV1::GetResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::AppstateV1::GetResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_state(state_key, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::AppstateV1::GetResponse::Representation
          command.response_class = Google2::Apis::AppstateV1::GetResponse
          command.params['stateKey'] = state_key unless state_key.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::AppstateV1::ListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::AppstateV1::ListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_states(include_data: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::AppstateV1::ListResponse::Representation
          command.response_class = Google2::Apis::AppstateV1::ListResponse
        ...
        # @param [Fixnum] state_key
        #   The key for the data to be retrieved.
        # @param [Google2::Apis::AppstateV1::UpdateRequest] update_request_object
        ...
        def update_state(state_key, update_request_object = nil, current_state_version: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::AppstateV1::UpdateRequest::Representation
