...
module Google2
  module Apis
    module FitnessV1
      ...
      #
      # @example
      #    require 'google2/apis/fitness_v1'
      #
      #    Fitness = Google2::Apis::FitnessV1 # Alias the module
      #    service = Fitness::FitnessService.new
      #
      # @see https://developers.google.com/fit/rest/
      class FitnessService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::FitnessV1::DataSource] data_source_object
        # @param [String] fields
        ...
        # @yieldparam result [Google2::Apis::FitnessV1::DataSource] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::FitnessV1::DataSource]
        #
        ...
        def create_user_data_source(user_id, data_source_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::FitnessV1::DataSource::Representation
          command.request_object = data_source_object
          command.response_representation = Google2::Apis::FitnessV1::DataSource::Representation
          command.response_class = Google2::Apis::FitnessV1::DataSource
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::FitnessV1::ListDataSourcesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::FitnessV1::ListDataSourcesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_user_data_sources(user_id, data_type_name: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::FitnessV1::ListDataSourcesResponse::Representation
          command.response_class = Google2::Apis::FitnessV1::ListDataSourcesResponse
          command.params['userId'] = user_id unless user_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::FitnessV1::Dataset] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::FitnessV1::Dataset]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_user_data_source_dataset(user_id, data_source_id, dataset_id, limit: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::FitnessV1::Dataset::Representation
          command.response_class = Google2::Apis::FitnessV1::Dataset
          command.params['userId'] = user_id unless user_id.nil?
          command.params['dataSourceId'] = data_source_id unless data_source_id.nil?
          command.params['datasetId'] = dataset_id unless dataset_id.nil?
        ...
        #   ID is formatted like: "startTime-endTime" where startTime and endTime are 64
        #   bit integers.
        # @param [Google2::Apis::FitnessV1::Dataset] dataset_object
        # @param [String] current_time_millis
        ...
        def patch_user_data_source_dataset(user_id, data_source_id, dataset_id, dataset_object = nil, current_time_millis: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::FitnessV1::Dataset::Representation
        ...
        # @param [Google2::Apis::FitnessV1::AggregateRequest] aggregate_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::FitnessV1::AggregateResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::FitnessV1::AggregateResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def aggregate_dataset(user_id, aggregate_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::FitnessV1::AggregateRequest::Representation
          command.request_object = aggregate_request_object
          command.response_representation = Google2::Apis::FitnessV1::AggregateResponse::Representation
          command.response_class = Google2::Apis::FitnessV1::AggregateResponse
          command.params['userId'] = user_id unless user_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::FitnessV1::ListSessionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::FitnessV1::ListSessionsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_user_sessions(user_id, end_time: nil, include_deleted: nil, page_token: nil, start_time: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::FitnessV1::ListSessionsResponse::Representation
          command.response_class = Google2::Apis::FitnessV1::ListSessionsResponse
          command.params['userId'] = user_id unless user_id.nil?
        ...
        # @param [Google2::Apis::FitnessV1::Session] session_object
        # @param [String] current_time_millis
        #   The client's current time in milliseconds since epoch.
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::FitnessV1::Session] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        def update_user_session(user_id, session_id, session_object = nil, current_time_millis: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::FitnessV1::Session::Representation
          command.request_object = session_object
          command.response_representation = Google2::Apis::FitnessV1::Session::Representation
          command.response_class = Google2::Apis::FitnessV1::Session
          command.params['userId'] = user_id unless user_id.nil?
          command.params['sessionId'] = session_id unless session_id.nil?
          command.query['currentTimeMillis'] = current_time_millis unless current_time_millis.nil?
          command.query['fields'] = fields unless fields.nil?
