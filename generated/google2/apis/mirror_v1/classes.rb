  ...
  module Apis
    module MirrorV1
      ...
      class Account
        ...
        # @return [Array<Google2::Apis::MirrorV1::AuthToken>]
        ...
        # @return [Array<Google2::Apis::MirrorV1::UserData>]
      ...
      class ListAttachmentsResponse
        ...
        # @return [Array<Google2::Apis::MirrorV1::Attachment>]
        attr_accessor :items
      ...
      class Contact
        ...
        # @return [Array<Google2::Apis::MirrorV1::Command>]
      ...
      class ListContactsResponse
        ...
        # Contact list.
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::MirrorV1::Contact>]
        attr_accessor :items
      ...
      class ListLocationsResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::MirrorV1::Location>]
        attr_accessor :items
      ...
      class MenuItem
        ...
        # @return [Array<Google2::Apis::MirrorV1::MenuValue>]
      ...
      class Notification
        ...
        # @return [Array<Google2::Apis::MirrorV1::UserAction>]
      ...
      class Subscription
        ...
        # @return [Google2::Apis::MirrorV1::Notification]
      ...
      class ListSubscriptionsResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::MirrorV1::Subscription>]
        attr_accessor :items
      ...
      class TimelineItem
        ...
        # @return [Array<Google2::Apis::MirrorV1::MenuItem>]
        attr_accessor :menu_items
      
        # Controls how notifications for a timeline item are presented to the user.
        # Corresponds to the JSON property `notification`
        # @return [Google2::Apis::MirrorV1::NotificationConfig]
        attr_accessor :notification
      ...
      class ListTimelineResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::MirrorV1::TimelineItem>]
        attr_accessor :items
