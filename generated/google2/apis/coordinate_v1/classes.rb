  ...
  module Apis
    module CoordinateV1
      ...
      class CustomFieldDef
        ...
        # @return [Array<Google2::Apis::CoordinateV1::EnumItemDef>]
      ...
      class ListCustomFieldDefResponse
        ...
        # @return [Array<Google2::Apis::CoordinateV1::CustomFieldDef>]
        attr_accessor :items
      ...
      class CustomFields
        ...
        # @return [Array<Google2::Apis::CoordinateV1::CustomField>]
      ...
      class Job
        ...
        # @return [Array<Google2::Apis::CoordinateV1::JobChange>]
        ...
        # @return [Google2::Apis::CoordinateV1::JobState]
        attr_accessor :state
      ...
      class ListJobResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CoordinateV1::Job>]
        attr_accessor :items
      ...
      class JobState
        ...
        # @return [Google2::Apis::CoordinateV1::CustomFields]
        ...
        # @return [Google2::Apis::CoordinateV1::Location]
      ...
      class ListLocationResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CoordinateV1::LocationRecord>]
        attr_accessor :items
        ...
        # @return [Google2::Apis::CoordinateV1::TokenPagination]
      ...
      class ListTeamResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CoordinateV1::Team>]
        attr_accessor :items
      ...
      class ListWorkerResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CoordinateV1::Worker>]
        attr_accessor :items
