...
module Google2
  module Apis
    module GroupssettingsV1
      ...
      #
      # @example
      #    require 'google2/apis/groupssettings_v1'
      #
      #    Groupssettings = Google2::Apis::GroupssettingsV1 # Alias the module
      #    service = Groupssettings::GroupssettingsService.new
      #
      # @see https://developers.google.com/google-apps/groups-settings/get_started
      class GroupssettingsService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::GroupssettingsV1::Groups] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::GroupssettingsV1::Groups]
        #
        ...
        def get_group(group_unique_id, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::GroupssettingsV1::Groups::Representation
          command.response_class = Google2::Apis::GroupssettingsV1::Groups
        ...
        # @param [String] group_unique_id
        #   The resource ID
        # @param [Google2::Apis::GroupssettingsV1::Groups] groups_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def patch_group(group_unique_id, groups_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::GroupssettingsV1::Groups::Representation
