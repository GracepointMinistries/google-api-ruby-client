  ...
  module Apis
    module CivicinfoV2
      ...
      class AdministrationRegion
        ...
        # @return [Google2::Apis::CivicinfoV2::AdministrativeBody]
        ...
        # @return [Google2::Apis::CivicinfoV2::AdministrationRegion]
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::Source>]
      ...
      class AdministrativeBody
        ...
        # @return [Google2::Apis::CivicinfoV2::SimpleAddressType]
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::ElectionOfficial>]
      ...
      class Candidate
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::Channel>]
      ...
      class Contest
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::Candidate>]
        attr_accessor :candidates
      
        # Describes the geographic scope of a contest.
        # Corresponds to the JSON property `district`
        # @return [Google2::Apis::CivicinfoV2::ElectoralDistrict]
      ...
      class DivisionSearchResponse
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::DivisionSearchResult>]
      ...
      class QueryElectionsResponse
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::Election>]
      ...
      class Official
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::SimpleAddressType>]
      ...
      class RepresentativeInfoData
        ...
        # @return [Hash<String,Google2::Apis::CivicinfoV2::GeographicDivision>]
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::Office>]
        attr_accessor :offices
      
        # Officials holding the offices listed above. Will only be present if
        # includeOffices was true in the request.
        # Corresponds to the JSON property `officials`
        # @return [Array<Google2::Apis::CivicinfoV2::Official>]
      ...
      class VoterInfoResponse
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::Contest>]
        ...
        # @return [Array<Google2::Apis::CivicinfoV2::PollingLocation>]
        ...
        # @return [Google2::Apis::CivicinfoV2::Election]
        ...
        # Corresponds to the JSON property `state`
        # @return [Array<Google2::Apis::CivicinfoV2::AdministrationRegion>]
        attr_accessor :state
