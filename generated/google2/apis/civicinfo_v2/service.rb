...
module Google2
  module Apis
    module CivicinfoV2
      ...
      #
      # @example
      #    require 'google2/apis/civicinfo_v2'
      #
      #    Civicinfo = Google2::Apis::CivicinfoV2 # Alias the module
      #    service = Civicinfo::CivicInfoService.new
      #
      # @see https://developers.google.com/civic-information
      class CivicInfoService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::CivicinfoV2::DivisionSearchResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CivicinfoV2::DivisionSearchResponse]
        #
        ...
        def search_divisions(query: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::CivicinfoV2::DivisionSearchResponse::Representation
          command.response_class = Google2::Apis::CivicinfoV2::DivisionSearchResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CivicinfoV2::QueryElectionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CivicinfoV2::QueryElectionsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def query_election(fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::CivicinfoV2::QueryElectionsResponse::Representation
          command.response_class = Google2::Apis::CivicinfoV2::QueryElectionsResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CivicinfoV2::VoterInfoResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CivicinfoV2::VoterInfoResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def query_voter_info(address, election_id: nil, official_only: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::CivicinfoV2::VoterInfoResponse::Representation
          command.response_class = Google2::Apis::CivicinfoV2::VoterInfoResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CivicinfoV2::RepresentativeInfoResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CivicinfoV2::RepresentativeInfoResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def representative_info_by_address(address: nil, include_offices: nil, levels: nil, roles: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::CivicinfoV2::RepresentativeInfoResponse::Representation
          command.response_class = Google2::Apis::CivicinfoV2::RepresentativeInfoResponse
          command.query['address'] = address unless address.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::CivicinfoV2::RepresentativeInfoData] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::CivicinfoV2::RepresentativeInfoData]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def representative_info_by_division(ocd_id, levels: nil, recursive: nil, roles: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::CivicinfoV2::RepresentativeInfoData::Representation
          command.response_class = Google2::Apis::CivicinfoV2::RepresentativeInfoData
