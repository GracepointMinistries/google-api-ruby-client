...
module Google2
  module Apis
    module DeploymentmanagerV2beta2
      ...
      #
      # @example
      #    require 'google2/apis/deploymentmanager_v2beta2'
      #
      #    Deploymentmanager = Google2::Apis::DeploymentmanagerV2beta2 # Alias the module
      ...
      class DeploymentManagerService < Google2::Apis::Core::BaseService
        ...
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::Operation]
        #
        ...
        def delete_deployment(project, deployment, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::Operation::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::Operation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::Deployment] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::Deployment]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_deployment(project, deployment, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::Deployment::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::Deployment
          command.params['project'] = project unless project.nil?
          command.params['deployment'] = deployment unless deployment.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [String] project
        #   The project ID for this request.
        # @param [Google2::Apis::DeploymentmanagerV2beta2::Deployment] deployment_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_deployment(project, deployment_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::DeploymentmanagerV2beta2::Deployment::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::ListDeploymentsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::ListDeploymentsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_deployments(project, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::ListDeploymentsResponse::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::ListDeploymentsResponse
          command.params['project'] = project unless project.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::Manifest] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::Manifest]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_manifest(project, deployment, manifest, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::Manifest::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::Manifest
          command.params['project'] = project unless project.nil?
          command.params['deployment'] = deployment unless deployment.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::ListManifestsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::ListManifestsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_manifests(project, deployment, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::ListManifestsResponse::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::ListManifestsResponse
          command.params['project'] = project unless project.nil?
          command.params['deployment'] = deployment unless deployment.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::ListOperationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::ListOperationsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_operations(project, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::ListOperationsResponse::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::ListOperationsResponse
          command.params['project'] = project unless project.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::Resource] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::Resource]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_resource(project, deployment, resource, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::Resource::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::Resource
          command.params['project'] = project unless project.nil?
          command.params['deployment'] = deployment unless deployment.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::ListResourcesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::ListResourcesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_resources(project, deployment, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::ListResourcesResponse::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::ListResourcesResponse
          command.params['project'] = project unless project.nil?
          command.params['deployment'] = deployment unless deployment.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::DeploymentmanagerV2beta2::ListTypesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::DeploymentmanagerV2beta2::ListTypesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_types(project, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::DeploymentmanagerV2beta2::ListTypesResponse::Representation
          command.response_class = Google2::Apis::DeploymentmanagerV2beta2::ListTypesResponse
          command.params['project'] = project unless project.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
