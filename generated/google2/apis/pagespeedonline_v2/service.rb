...
module Google2
  module Apis
    module PagespeedonlineV2
      ...
      #
      # @example
      #    require 'google2/apis/pagespeedonline_v2'
      #
      #    Pagespeedonline = Google2::Apis::PagespeedonlineV2 # Alias the module
      #    service = Pagespeedonline::PagespeedonlineService.new
      #
      # @see https://developers.google.com/speed/docs/insights/v2/getting-started
      class PagespeedonlineService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::PagespeedonlineV2::Result] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PagespeedonlineV2::Result]
        #
        ...
        def run_pagespeed(url, filter_third_party_resources: nil, locale: nil, rule: nil, screenshot: nil, strategy: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PagespeedonlineV2::Result::Representation
          command.response_class = Google2::Apis::PagespeedonlineV2::Result
