  ...
  module Apis
    module TaskqueueV1beta2
      ...
      class TaskQueue
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          property :acl, as: 'acl', class: Google2::Apis::TaskqueueV1beta2::TaskQueue::Acl, decorator: Google2::Apis::TaskqueueV1beta2::TaskQueue::Acl::Representation
      
          property :id, as: 'id'
          property :kind, as: 'kind'
          property :max_leases, as: 'maxLeases'
          property :stats, as: 'stats', class: Google2::Apis::TaskqueueV1beta2::TaskQueue::Stats, decorator: Google2::Apis::TaskqueueV1beta2::TaskQueue::Stats::Representation
      ...
      class Tasks
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :items, as: 'items', class: Google2::Apis::TaskqueueV1beta2::Task, decorator: Google2::Apis::TaskqueueV1beta2::Task::Representation
