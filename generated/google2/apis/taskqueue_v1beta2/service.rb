...
module Google2
  module Apis
    module TaskqueueV1beta2
      ...
      #
      # @example
      #    require 'google2/apis/taskqueue_v1beta2'
      #
      #    Taskqueue = Google2::Apis::TaskqueueV1beta2 # Alias the module
      #    service = Taskqueue::TaskqueueService.new
      #
      # @see https://developers.google.com/appengine/docs/python/taskqueue/rest
      class TaskqueueService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::TaskqueueV1beta2::TaskQueue] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::TaskqueueV1beta2::TaskQueue]
        #
        ...
        def get_taskqueue(project, taskqueue, get_stats: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::TaskqueueV1beta2::TaskQueue::Representation
          command.response_class = Google2::Apis::TaskqueueV1beta2::TaskQueue
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::TaskqueueV1beta2::Task] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::TaskqueueV1beta2::Task]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_task(project, taskqueue, task, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::TaskqueueV1beta2::Task::Representation
          command.response_class = Google2::Apis::TaskqueueV1beta2::Task
          command.params['project'] = project unless project.nil?
          command.params['taskqueue'] = taskqueue unless taskqueue.nil?
          command.params['task'] = task unless task.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        # @param [Google2::Apis::TaskqueueV1beta2::Task] task_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_task(project, taskqueue, task_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::TaskqueueV1beta2::Task::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::TaskqueueV1beta2::Tasks] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::TaskqueueV1beta2::Tasks]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def lease_task(project, taskqueue, num_tasks, lease_secs, group_by_tag: nil, tag: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::TaskqueueV1beta2::Tasks::Representation
          command.response_class = Google2::Apis::TaskqueueV1beta2::Tasks
          command.params['project'] = project unless project.nil?
          command.params['taskqueue'] = taskqueue unless taskqueue.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::TaskqueueV1beta2::Tasks2] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::TaskqueueV1beta2::Tasks2]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_tasks(project, taskqueue, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::TaskqueueV1beta2::Tasks2::Representation
          command.response_class = Google2::Apis::TaskqueueV1beta2::Tasks2
          command.params['project'] = project unless project.nil?
          command.params['taskqueue'] = taskqueue unless taskqueue.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
