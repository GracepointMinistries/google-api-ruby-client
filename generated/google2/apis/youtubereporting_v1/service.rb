...
module Google2
  module Apis
    module YoutubereportingV1
      ...
      #
      # @example
      #    require 'google2/apis/youtubereporting_v1'
      #
      #    Youtubereporting = Google2::Apis::YoutubereportingV1 # Alias the module
      #    service = Youtubereporting::YouTubeReportingService.new
      #
      # @see https://developers.google.com/youtube/reporting/v1/reports/
      class YouTubeReportingService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::YoutubereportingV1::Media] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::Media]
        #
        ...
        def download_medium(resource_name, fields: nil, quota_user: nil, download_dest: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubereportingV1::Media::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::Media
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubereportingV1::ListReportTypesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::ListReportTypesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_report_types(on_behalf_of_content_owner: nil, page_size: nil, page_token: nil, include_system_managed: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubereportingV1::ListReportTypesResponse::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::ListReportTypesResponse
        ...
        # @param [Google2::Apis::YoutubereportingV1::Job] job_object
        # @param [String] on_behalf_of_content_owner
        #   The content owner's external ID on which behalf the user is acting on. If not
        #   set, the user is acting for himself (his own channel).
        # @param [String] fields
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubereportingV1::Job] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::Job]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def create_job(job_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubereportingV1::Job::Representation
          command.request_object = job_object
          command.response_representation = Google2::Apis::YoutubereportingV1::Job::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::Job
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubereportingV1::ListJobsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::ListJobsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_jobs(on_behalf_of_content_owner: nil, page_size: nil, page_token: nil, include_system_managed: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubereportingV1::ListJobsResponse::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::ListJobsResponse
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['includeSystemManaged'] = include_system_managed unless include_system_managed.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubereportingV1::Empty] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::Empty]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def delete_job(job_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubereportingV1::Empty::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::Empty
          command.params['jobId'] = job_id unless job_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubereportingV1::ListReportsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::ListReportsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_job_reports(job_id, on_behalf_of_content_owner: nil, page_size: nil, page_token: nil, created_after: nil, start_time_at_or_after: nil, start_time_before: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubereportingV1::ListReportsResponse::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::ListReportsResponse
          command.params['jobId'] = job_id unless job_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubereportingV1::Report] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubereportingV1::Report]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_job_report(job_id, report_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubereportingV1::Report::Representation
          command.response_class = Google2::Apis::YoutubereportingV1::Report
          command.params['jobId'] = job_id unless job_id.nil?
