  ...
  module Apis
    module ClouduseraccountsBeta
      ...
      class GroupList
        ...
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::Group>]
        attr_accessor :items
      ...
      class LinuxAccountViews
        ...
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::LinuxGroupView>]
        ...
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::LinuxUserView>]
      ...
      class LinuxGetAuthorizedKeysViewResponse
        ...
        # @return [Google2::Apis::ClouduseraccountsBeta::AuthorizedKeysView]
      ...
      class LinuxGetLinuxAccountViewsResponse
        ...
        # managed by the Compute Engine Accounts API.
        # Corresponds to the JSON property `resource`
        # @return [Google2::Apis::ClouduseraccountsBeta::LinuxAccountViews]
        attr_accessor :resource
      ...
      class Operation
        ...
        # @return [Google2::Apis::ClouduseraccountsBeta::Operation::Error]
        attr_accessor :error
        ...
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::Operation::Warning>]
        ...
        class Error
          ...
          # @return [Array<Google2::Apis::ClouduseraccountsBeta::Operation::Error::Error>]
        ...
        class Warning
          ...
          # @return [Array<Google2::Apis::ClouduseraccountsBeta::Operation::Warning::Datum>]
          attr_accessor :data
      ...
      class OperationList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::Operation>]
        attr_accessor :items
      ...
      class User
        ...
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::PublicKey>]
      ...
      class UserList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::ClouduseraccountsBeta::User>]
        attr_accessor :items
