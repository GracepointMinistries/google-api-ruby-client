...
module Google2
  module Apis
    module ReplicapoolupdaterV1beta1
      ...
      #
      # @example
      #    require 'google2/apis/replicapoolupdater_v1beta1'
      #
      #    Replicapoolupdater = Google2::Apis::ReplicapoolupdaterV1beta1 # Alias the module
      ...
      class ReplicapoolupdaterService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::ReplicapoolupdaterV1beta1::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolupdaterV1beta1::Operation]
        #
        ...
        def cancel_rolling_update(project, zone, rolling_update, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolupdaterV1beta1::Operation::Representation
          command.response_class = Google2::Apis::ReplicapoolupdaterV1beta1::Operation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdate] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdate]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_rolling_update(project, zone, rolling_update, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdate::Representation
          command.response_class = Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdate
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.params['rollingUpdate'] = rolling_update unless rolling_update.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        # @param [String] zone
        #   The name of the zone in which the update's target resides.
        # @param [Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdate] rolling_update_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_rolling_update(project, zone, rolling_update_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdate::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdateList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdateList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_rolling_updates(project, zone, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdateList::Representation
          command.response_class = Google2::Apis::ReplicapoolupdaterV1beta1::RollingUpdateList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolupdaterV1beta1::InstanceUpdateList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolupdaterV1beta1::InstanceUpdateList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_instance_updates(project, zone, rolling_update, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolupdaterV1beta1::InstanceUpdateList::Representation
          command.response_class = Google2::Apis::ReplicapoolupdaterV1beta1::InstanceUpdateList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.params['rollingUpdate'] = rolling_update unless rolling_update.nil?
          command.query['filter'] = filter unless filter.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolupdaterV1beta1::OperationList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolupdaterV1beta1::OperationList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_zone_operations(project, zone, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolupdaterV1beta1::OperationList::Representation
          command.response_class = Google2::Apis::ReplicapoolupdaterV1beta1::OperationList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
