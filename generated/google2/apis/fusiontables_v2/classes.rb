  ...
  module Apis
    module FusiontablesV2
      ...
      class Column
        ...
        # @return [Google2::Apis::FusiontablesV2::Column::BaseColumn]
      ...
      class ColumnList
        ...
        # @return [Array<Google2::Apis::FusiontablesV2::Column>]
        attr_accessor :items
      ...
      class LineStyle
        ...
        # @return [Google2::Apis::FusiontablesV2::StyleFunction]
      ...
      class StyleFunction
        ...
        # @return [Array<Google2::Apis::FusiontablesV2::Bucket>]
        ...
        # @return [Google2::Apis::FusiontablesV2::StyleFunction::Gradient]
        ...
        class Gradient
          ...
          # @return [Array<Google2::Apis::FusiontablesV2::StyleFunction::Gradient::Color>]
      ...
      class StyleSetting
        ...
        # @return [Google2::Apis::FusiontablesV2::PointStyle]
        ...
        # @return [Google2::Apis::FusiontablesV2::PolygonStyle]
        attr_accessor :polygon_options
      
        # Represents a LineStyle within a StyleSetting
        # Corresponds to the JSON property `polylineOptions`
        # @return [Google2::Apis::FusiontablesV2::LineStyle]
      ...
      class StyleSettingList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::FusiontablesV2::StyleSetting>]
        attr_accessor :items
      ...
      class TableList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::FusiontablesV2::Table>]
        attr_accessor :items
      ...
      class TaskList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::FusiontablesV2::Task>]
        attr_accessor :items
      ...
      class TemplateList
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::FusiontablesV2::Template>]
        attr_accessor :items
