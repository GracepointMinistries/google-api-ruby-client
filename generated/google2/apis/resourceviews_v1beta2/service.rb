...
module Google2
  module Apis
    module ResourceviewsV1beta2
      ...
      #
      # @example
      #    require 'google2/apis/resourceviews_v1beta2'
      #
      #    Resourceviews = Google2::Apis::ResourceviewsV1beta2 # Alias the module
      #    service = Resourceviews::ResourceviewsService.new
      #
      # @see https://developers.google.com/compute/
      class ResourceviewsService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::ResourceviewsV1beta2::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ResourceviewsV1beta2::Operation]
        #
        ...
        def get_zone_operation(project, zone, operation, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ResourceviewsV1beta2::Operation::Representation
          command.response_class = Google2::Apis::ResourceviewsV1beta2::Operation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ResourceviewsV1beta2::OperationList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ResourceviewsV1beta2::OperationList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_zone_operations(project, zone, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ResourceviewsV1beta2::OperationList::Representation
          command.response_class = Google2::Apis::ResourceviewsV1beta2::OperationList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
        ...
        # @param [Google2::Apis::ResourceviewsV1beta2::AddResourcesRequest] add_resources_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def add_zone_view_resources(project, zone, resource_view, add_resources_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ResourceviewsV1beta2::AddResourcesRequest::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ResourceviewsV1beta2::ResourceView] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ResourceviewsV1beta2::ResourceView]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_zone_view(project, zone, resource_view, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ResourceviewsV1beta2::ResourceView::Representation
          command.response_class = Google2::Apis::ResourceviewsV1beta2::ResourceView
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.params['resourceView'] = resource_view unless resource_view.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ResourceviewsV1beta2::GetServiceResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ResourceviewsV1beta2::GetServiceResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_zone_view_service(project, zone, resource_view, resource_name: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ResourceviewsV1beta2::GetServiceResponse::Representation
          command.response_class = Google2::Apis::ResourceviewsV1beta2::GetServiceResponse
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.params['resourceView'] = resource_view unless resource_view.nil?
        ...
        # @param [String] zone
        #   The zone name of the resource view.
        # @param [Google2::Apis::ResourceviewsV1beta2::ResourceView] resource_view_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_zone_view(project, zone, resource_view_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ResourceviewsV1beta2::ResourceView::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ResourceviewsV1beta2::ZoneViewsList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ResourceviewsV1beta2::ZoneViewsList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_zone_views(project, zone, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ResourceviewsV1beta2::ZoneViewsList::Representation
          command.response_class = Google2::Apis::ResourceviewsV1beta2::ZoneViewsList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ResourceviewsV1beta2::ListResourcesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ResourceviewsV1beta2::ListResourcesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_zone_view_resources(project, zone, resource_view, format: nil, list_state: nil, max_results: nil, page_token: nil, service_name: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ResourceviewsV1beta2::ListResourcesResponse::Representation
          command.response_class = Google2::Apis::ResourceviewsV1beta2::ListResourcesResponse
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.params['resourceView'] = resource_view unless resource_view.nil?
        ...
        # @param [String] resource_view
        #   The name of the resource view.
        # @param [Google2::Apis::ResourceviewsV1beta2::RemoveResourcesRequest] remove_resources_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def remove_zone_view_resources(project, zone, resource_view, remove_resources_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ResourceviewsV1beta2::RemoveResourcesRequest::Representation
        ...
        # @param [String] resource_view
        #   The name of the resource view.
        # @param [Google2::Apis::ResourceviewsV1beta2::SetServiceRequest] set_service_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def set_zone_view_service(project, zone, resource_view, set_service_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ResourceviewsV1beta2::SetServiceRequest::Representation
