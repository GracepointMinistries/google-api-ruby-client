...
module Google2
  module Apis
    module AppsactivityV1
      ...
      #
      # @example
      #    require 'google2/apis/appsactivity_v1'
      #
      #    Appsactivity = Google2::Apis::AppsactivityV1 # Alias the module
      #    service = Appsactivity::AppsactivityService.new
      #
      # @see https://developers.google.com/google-apps/activity/
      class AppsactivityService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::AppsactivityV1::ListActivitiesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::AppsactivityV1::ListActivitiesResponse]
        #
        ...
        def list_activities(drive_ancestor_id: nil, drive_file_id: nil, grouping_strategy: nil, page_size: nil, page_token: nil, source: nil, user_id: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::AppsactivityV1::ListActivitiesResponse::Representation
          command.response_class = Google2::Apis::AppsactivityV1::ListActivitiesResponse
