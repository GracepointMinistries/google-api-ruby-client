  ...
  module Apis
    module AppsactivityV1
      ...
      class Activity
        ...
        # @return [Google2::Apis::AppsactivityV1::Event]
        attr_accessor :combined_event
      
        # A list of all the Events that make up the Activity.
        # Corresponds to the JSON property `singleEvents`
        # @return [Array<Google2::Apis::AppsactivityV1::Event>]
      ...
      class Event
        ...
        # @return [Google2::Apis::AppsactivityV1::Move]
        attr_accessor :move
        ...
        # @return [Array<Google2::Apis::AppsactivityV1::PermissionChange>]
        ...
        # @return [Google2::Apis::AppsactivityV1::Rename]
        attr_accessor :rename
      
        # Information about the object modified by the event.
        # Corresponds to the JSON property `target`
        # @return [Google2::Apis::AppsactivityV1::Target]
        attr_accessor :target
      
        # A representation of a user.
        # Corresponds to the JSON property `user`
        # @return [Google2::Apis::AppsactivityV1::User]
        attr_accessor :user
      ...
      class ListActivitiesResponse
        ...
        # @return [Array<Google2::Apis::AppsactivityV1::Activity>]
      ...
      class Move
        ...
        # @return [Array<Google2::Apis::AppsactivityV1::Parent>]
      ...
      class PermissionChange
        ...
        # @return [Array<Google2::Apis::AppsactivityV1::Permission>]
      ...
      class User
        ...
        # @return [Google2::Apis::AppsactivityV1::Photo]
        attr_accessor :photo
