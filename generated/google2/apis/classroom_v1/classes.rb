  ...
  module Apis
    module ClassroomV1
      ...
      class Course
        ...
        # @return [Google2::Apis::ClassroomV1::DriveFolder]
        attr_accessor :teacher_folder
      
        # Sets of materials that appear on the "about" page of this course. Read-only.
        # Corresponds to the JSON property `courseMaterialSets`
        # @return [Array<Google2::Apis::ClassroomV1::CourseMaterialSet>]
      ...
      class CourseMaterialSet
        ...
        # @return [Array<Google2::Apis::ClassroomV1::CourseMaterial>]
      ...
      class CourseMaterial
        ...
        # @return [Google2::Apis::ClassroomV1::DriveFile]
        attr_accessor :drive_file
      
        # YouTube video item.
        # Corresponds to the JSON property `youTubeVideo`
        # @return [Google2::Apis::ClassroomV1::YouTubeVideo]
        attr_accessor :you_tube_video
      
        # URL item.
        # Corresponds to the JSON property `link`
        # @return [Google2::Apis::ClassroomV1::Link]
        attr_accessor :link
      
        # Google Forms item.
        # Corresponds to the JSON property `form`
        # @return [Google2::Apis::ClassroomV1::Form]
        attr_accessor :form
      ...
      class ListCoursesResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::Course>]
      ...
      class ListCourseAliasesResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::CourseAlias>]
      ...
      class ListInvitationsResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::Invitation>]
      ...
      class UserProfile
        ...
        # Corresponds to the JSON property `name`
        # @return [Google2::Apis::ClassroomV1::Name]
        attr_accessor :name
        ...
        # @return [Array<Google2::Apis::ClassroomV1::GlobalPermission>]
      ...
      class ListTeachersResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::Teacher>]
      ...
      class ListStudentsResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::Student>]
      ...
      class CourseWork
        ...
        # Corresponds to the JSON property `materials`
        # @return [Array<Google2::Apis::ClassroomV1::Material>]
        attr_accessor :materials
        ...
        # @return [Google2::Apis::ClassroomV1::Date]
        ...
        # @return [Google2::Apis::ClassroomV1::TimeOfDay]
        ...
        # @return [Google2::Apis::ClassroomV1::Assignment]
        attr_accessor :assignment
      
        # Additional details for multiple-choice questions.
        # Corresponds to the JSON property `multipleChoiceQuestion`
        # @return [Google2::Apis::ClassroomV1::MultipleChoiceQuestion]
      ...
      class Material
        ...
        # Corresponds to the JSON property `driveFile`
        # @return [Google2::Apis::ClassroomV1::SharedDriveFile]
        attr_accessor :drive_file
      ...
      class ListCourseWorkResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::CourseWork>]
      ...
      class AssignmentSubmission
        ...
        # @return [Array<Google2::Apis::ClassroomV1::Attachment>]
      ...
      class ListStudentSubmissionsResponse
        ...
        # @return [Array<Google2::Apis::ClassroomV1::StudentSubmission>]
