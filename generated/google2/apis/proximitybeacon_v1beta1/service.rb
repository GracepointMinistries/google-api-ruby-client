...
module Google2
  module Apis
    module ProximitybeaconV1beta1
      ...
      #
      # @example
      #    require 'google2/apis/proximitybeacon_v1beta1'
      #
      #    Proximitybeacon = Google2::Apis::ProximitybeaconV1beta1 # Alias the module
      #    service = Proximitybeacon::ProximitybeaconService.new
      #
      # @see https://developers.google.com/beacons/proximity/
      class ProximitybeaconService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::ProximitybeaconV1beta1::Beacon] beacon_object
        ...
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::Beacon] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::Beacon]
        #
        ...
        def register_beacon(beacon_object = nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ProximitybeaconV1beta1::Beacon::Representation
          command.request_object = beacon_object
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::Beacon::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::Beacon
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::Empty] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::Empty]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def decommission_beacon(beacon_name, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::Empty::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::Empty
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::ListBeaconsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::ListBeaconsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_beacons(q: nil, page_token: nil, page_size: nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::ListBeaconsResponse::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::ListBeaconsResponse
        ...
        #   stable" UID. Required.
        # @param [Google2::Apis::ProximitybeaconV1beta1::BeaconAttachment] beacon_attachment_object
        # @param [String] project_id
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::BeaconAttachment] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::BeaconAttachment]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def create_beacon_attachment(beacon_name, beacon_attachment_object = nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ProximitybeaconV1beta1::BeaconAttachment::Representation
          command.request_object = beacon_attachment_object
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::BeaconAttachment::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::BeaconAttachment
          command.params['beaconName'] = beacon_name unless beacon_name.nil?
          command.query['projectId'] = project_id unless project_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::ListBeaconAttachmentsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::ListBeaconAttachmentsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_beacon_attachments(beacon_name, namespaced_type: nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::ListBeaconAttachmentsResponse::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::ListBeaconAttachmentsResponse
          command.params['beaconName'] = beacon_name unless beacon_name.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::DeleteAttachmentsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::DeleteAttachmentsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def batch_beacon_attachment_delete(beacon_name, namespaced_type: nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::DeleteAttachmentsResponse::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::DeleteAttachmentsResponse
          command.params['beaconName'] = beacon_name unless beacon_name.nil?
          command.query['namespacedType'] = namespaced_type unless namespaced_type.nil?
          command.query['projectId'] = project_id unless project_id.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::ListDiagnosticsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::ListDiagnosticsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_beacon_diagnostics(beacon_name, page_size: nil, page_token: nil, alert_filter: nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::ListDiagnosticsResponse::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::ListDiagnosticsResponse
          command.params['beaconName'] = beacon_name unless beacon_name.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::ListNamespacesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::ListNamespacesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_namespaces(project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::ListNamespacesResponse::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::ListNamespacesResponse
          command.query['projectId'] = project_id unless project_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #   namespace.
        # @param [Google2::Apis::ProximitybeaconV1beta1::Namespace] namespace_object
        # @param [String] project_id
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::Namespace] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::Namespace]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def update_namespace(namespace_name, namespace_object = nil, project_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ProximitybeaconV1beta1::Namespace::Representation
          command.request_object = namespace_object
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::Namespace::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::Namespace
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::EphemeralIdRegistrationParams] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::EphemeralIdRegistrationParams]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_eidparams(fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::EphemeralIdRegistrationParams::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::EphemeralIdRegistrationParams
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
        ...
        # for the application.
        # @param [Google2::Apis::ProximitybeaconV1beta1::GetInfoForObservedBeaconsRequest] get_info_for_observed_beacons_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ProximitybeaconV1beta1::GetInfoForObservedBeaconsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ProximitybeaconV1beta1::GetInfoForObservedBeaconsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def getforobserved_beaconinfo(get_info_for_observed_beacons_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ProximitybeaconV1beta1::GetInfoForObservedBeaconsRequest::Representation
          command.request_object = get_info_for_observed_beacons_request_object
          command.response_representation = Google2::Apis::ProximitybeaconV1beta1::GetInfoForObservedBeaconsResponse::Representation
          command.response_class = Google2::Apis::ProximitybeaconV1beta1::GetInfoForObservedBeaconsResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
