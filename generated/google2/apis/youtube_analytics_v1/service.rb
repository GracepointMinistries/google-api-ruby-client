...
module Google2
  module Apis
    module YoutubeAnalyticsV1
      ...
      #
      # @example
      #    require 'google2/apis/youtube_analytics_v1'
      #
      #    YoutubeAnalytics = Google2::Apis::YoutubeAnalyticsV1 # Alias the module
      #    service = YoutubeAnalytics::YouTubeAnalyticsService.new
      #
      # @see http://developers.google.com/youtube/analytics/
      class YouTubeAnalyticsService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::BatchReportDefinitionList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::BatchReportDefinitionList]
        #
        ...
        def list_batch_report_definitions(on_behalf_of_content_owner, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::BatchReportDefinitionList::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::BatchReportDefinitionList
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::BatchReportList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::BatchReportList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_batch_reports(batch_report_definition_id, on_behalf_of_content_owner, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::BatchReportList::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::BatchReportList
        ...
        # @param [Google2::Apis::YoutubeAnalyticsV1::GroupItem] group_item_object
        # @param [String] on_behalf_of_content_owner
        #   Note: This parameter is intended exclusively for YouTube content partners.
        #   The onBehalfOfContentOwner parameter indicates that the request's
        #   authorization credentials identify a YouTube CMS user who is acting on behalf
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::GroupItem] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::GroupItem]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def insert_group_item(group_item_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubeAnalyticsV1::GroupItem::Representation
          command.request_object = group_item_object
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::GroupItem::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::GroupItem
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::ListGroupItemResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::ListGroupItemResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_group_items(group_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::ListGroupItemResponse::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::ListGroupItemResponse
        ...
        # Creates a group.
        # @param [Google2::Apis::YoutubeAnalyticsV1::Group] group_object
        # @param [String] on_behalf_of_content_owner
        #   Note: This parameter is intended exclusively for YouTube content partners.
        #   The onBehalfOfContentOwner parameter indicates that the request's
        #   authorization credentials identify a YouTube CMS user who is acting on behalf
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::Group] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::Group]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def insert_group(group_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubeAnalyticsV1::Group::Representation
          command.request_object = group_object
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::Group::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::Group
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::ListGroupsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::ListGroupsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_groups(id: nil, mine: nil, on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::ListGroupsResponse::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::ListGroupsResponse
          command.query['id'] = id unless id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubeAnalyticsV1::ResultTable] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubeAnalyticsV1::ResultTable]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def query_report(ids, start_date, end_date, metrics, currency: nil, dimensions: nil, filters: nil, max_results: nil, sort: nil, start_index: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubeAnalyticsV1::ResultTable::Representation
          command.response_class = Google2::Apis::YoutubeAnalyticsV1::ResultTable
