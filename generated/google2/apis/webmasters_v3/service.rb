...
module Google2
  module Apis
    module WebmastersV3
      ...
      #
      # @example
      #    require 'google2/apis/webmasters_v3'
      #
      #    Webmasters = Google2::Apis::WebmastersV3 # Alias the module
      #    service = Webmasters::WebmastersService.new
      #
      # @see https://developers.google.com/webmaster-tools/
      class WebmastersService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::WebmastersV3::SearchAnalyticsQueryRequest] search_analytics_query_request_object
        # @param [String] fields
        ...
        # @yieldparam result [Google2::Apis::WebmastersV3::SearchAnalyticsQueryResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::SearchAnalyticsQueryResponse]
        #
        ...
        def query_search_analytics(site_url, search_analytics_query_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::WebmastersV3::SearchAnalyticsQueryRequest::Representation
          command.request_object = search_analytics_query_request_object
          command.response_representation = Google2::Apis::WebmastersV3::SearchAnalyticsQueryResponse::Representation
          command.response_class = Google2::Apis::WebmastersV3::SearchAnalyticsQueryResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::WmxSitemap] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::WmxSitemap]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_sitemap(site_url, feedpath, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::WmxSitemap::Representation
          command.response_class = Google2::Apis::WebmastersV3::WmxSitemap
          command.params['siteUrl'] = site_url unless site_url.nil?
          command.params['feedpath'] = feedpath unless feedpath.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::ListSitemapsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::ListSitemapsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_sitemaps(site_url, sitemap_index: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::ListSitemapsResponse::Representation
          command.response_class = Google2::Apis::WebmastersV3::ListSitemapsResponse
          command.params['siteUrl'] = site_url unless site_url.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::WmxSite] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::WmxSite]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_site(site_url, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::WmxSite::Representation
          command.response_class = Google2::Apis::WebmastersV3::WmxSite
          command.params['siteUrl'] = site_url unless site_url.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::ListSitesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::ListSitesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_sites(fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::ListSitesResponse::Representation
          command.response_class = Google2::Apis::WebmastersV3::ListSitesResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::QueryUrlCrawlErrorsCountsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::QueryUrlCrawlErrorsCountsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def query_errors_count(site_url, category: nil, latest_counts_only: nil, platform: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::QueryUrlCrawlErrorsCountsResponse::Representation
          command.response_class = Google2::Apis::WebmastersV3::QueryUrlCrawlErrorsCountsResponse
          command.params['siteUrl'] = site_url unless site_url.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::UrlCrawlErrorsSample] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::UrlCrawlErrorsSample]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_errors_sample(site_url, url, category, platform, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::UrlCrawlErrorsSample::Representation
          command.response_class = Google2::Apis::WebmastersV3::UrlCrawlErrorsSample
          command.params['siteUrl'] = site_url unless site_url.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::WebmastersV3::ListUrlCrawlErrorsSamplesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::WebmastersV3::ListUrlCrawlErrorsSamplesResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_errors_samples(site_url, category, platform, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::WebmastersV3::ListUrlCrawlErrorsSamplesResponse::Representation
          command.response_class = Google2::Apis::WebmastersV3::ListUrlCrawlErrorsSamplesResponse
          command.params['siteUrl'] = site_url unless site_url.nil?
          command.query['category'] = category unless category.nil?
          command.query['platform'] = platform unless platform.nil?
          command.query['fields'] = fields unless fields.nil?
