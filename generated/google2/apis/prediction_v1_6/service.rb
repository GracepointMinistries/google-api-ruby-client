...
module Google2
  module Apis
    module PredictionV1_6
      ...
      #
      # @example
      #    require 'google2/apis/prediction_v1_6'
      #
      #    Prediction = Google2::Apis::PredictionV1_6 # Alias the module
      #    service = Prediction::PredictionService.new
      #
      # @see https://developers.google.com/prediction/docs/developer-guide
      class PredictionService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::PredictionV1_6::Input] input_object
        # @param [String] fields
        ...
        # @yieldparam result [Google2::Apis::PredictionV1_6::Output] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PredictionV1_6::Output]
        #
        ...
        def predict_hosted_model(project, hosted_model_name, input_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::PredictionV1_6::Input::Representation
          command.request_object = input_object
          command.response_representation = Google2::Apis::PredictionV1_6::Output::Representation
          command.response_class = Google2::Apis::PredictionV1_6::Output
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::PredictionV1_6::Analyze] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PredictionV1_6::Analyze]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def analyze_trained_model(project, id, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PredictionV1_6::Analyze::Representation
          command.response_class = Google2::Apis::PredictionV1_6::Analyze
          command.params['project'] = project unless project.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::PredictionV1_6::Insert2] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PredictionV1_6::Insert2]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_trained_model(project, id, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PredictionV1_6::Insert2::Representation
          command.response_class = Google2::Apis::PredictionV1_6::Insert2
          command.params['project'] = project unless project.nil?
          command.params['id'] = id unless id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [String] project
        #   The project associated with the model.
        # @param [Google2::Apis::PredictionV1_6::Insert] insert_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_trained_model(project, insert_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::PredictionV1_6::Insert::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::PredictionV1_6::List] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PredictionV1_6::List]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_trained_models(project, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PredictionV1_6::List::Representation
          command.response_class = Google2::Apis::PredictionV1_6::List
          command.params['project'] = project unless project.nil?
        ...
        # @param [String] id
        #   The unique name for the predictive model.
        # @param [Google2::Apis::PredictionV1_6::Update] update_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def update_trained_model(project, id, update_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::PredictionV1_6::Update::Representation
