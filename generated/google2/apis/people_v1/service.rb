...
module Google2
  module Apis
    module PeopleV1
      ...
      #
      # @example
      #    require 'google2/apis/people_v1'
      #
      #    People = Google2::Apis::PeopleV1 # Alias the module
      #    service = People::PeopleService.new
      #
      # @see https://developers.google.com/people/
      class PeopleService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::PeopleV1::Person] parsed result object
        ...
        def get_person(resource_name, request_mask_include_field: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PeopleV1::Person::Representation
          command.response_class = Google2::Apis::PeopleV1::Person
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::PeopleV1::GetPeopleResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PeopleV1::GetPeopleResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_people(resource_names: nil, request_mask_include_field: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PeopleV1::GetPeopleResponse::Representation
          command.response_class = Google2::Apis::PeopleV1::GetPeopleResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::PeopleV1::ListConnectionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::PeopleV1::ListConnectionsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_person_connections(resource_name, page_token: nil, page_size: nil, sort_order: nil, sync_token: nil, request_mask_include_field: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::PeopleV1::ListConnectionsResponse::Representation
          command.response_class = Google2::Apis::PeopleV1::ListConnectionsResponse
          command.params['resourceName'] = resource_name unless resource_name.nil?
