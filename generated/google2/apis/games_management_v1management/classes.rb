  ...
  module Apis
    module GamesManagementV1management
      ...
      class AchievementResetAllResponse
        ...
        # @return [Array<Google2::Apis::GamesManagementV1management::AchievementResetResponse>]
      ...
      class GamesPlayerExperienceInfoResource
        ...
        # @return [Google2::Apis::GamesManagementV1management::GamesPlayerLevelResource]
      ...
      class HiddenPlayer
        ...
        # @return [Google2::Apis::GamesManagementV1management::Player]
      ...
      class HiddenPlayerList
        ...
        # @return [Array<Google2::Apis::GamesManagementV1management::HiddenPlayer>]
        attr_accessor :items
      ...
      class Player
        ...
        # @return [Google2::Apis::GamesManagementV1management::GamesPlayerExperienceInfoResource]
        ...
        # @return [Google2::Apis::GamesManagementV1management::GamesPlayedResource]
        attr_accessor :last_played_with
      
        # An object representation of the individual components of the player's name.
        # For some players, these fields may not be present.
        # Corresponds to the JSON property `name`
        # @return [Google2::Apis::GamesManagementV1management::Player::Name]
        attr_accessor :name
        ...
        # @return [Google2::Apis::GamesManagementV1management::ProfileSettings]
      ...
      class PlayerScoreResetAllResponse
        ...
        # Corresponds to the JSON property `results`
        # @return [Array<Google2::Apis::GamesManagementV1management::PlayerScoreResetResponse>]
        attr_accessor :results
