...
module Google2
  module Apis
    module KgsearchV1
      ...
      #
      # @example
      #    require 'google2/apis/kgsearch_v1'
      #
      #    Kgsearch = Google2::Apis::KgsearchV1 # Alias the module
      #    service = Kgsearch::KgsearchService.new
      #
      # @see https://developers.google.com/knowledge-graph/
      class KgsearchService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [Google2::Apis::KgsearchV1::SearchResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::KgsearchV1::SearchResponse]
        #
        ...
        def search_entities(query: nil, ids: nil, languages: nil, types: nil, indent: nil, prefix: nil, limit: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::KgsearchV1::SearchResponse::Representation
          command.response_class = Google2::Apis::KgsearchV1::SearchResponse
