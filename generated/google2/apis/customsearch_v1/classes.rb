  ...
  module Apis
    module CustomsearchV1
      ...
      class Context
        ...
        # @return [Array<Array<Google2::Apis::CustomsearchV1::Context::Facet>>]
      ...
      class Promotion
        ...
        # @return [Array<Google2::Apis::CustomsearchV1::Promotion::BodyLine>]
        ...
        # @return [Google2::Apis::CustomsearchV1::Promotion::Image]
        attr_accessor :image
      ...
      class Result
        ...
        # 
        # Corresponds to the JSON property `image`
        # @return [Google2::Apis::CustomsearchV1::Result::Image]
        attr_accessor :image
        ...
        # @return [Array<Google2::Apis::CustomsearchV1::Result::Label>]
      ...
      class Search
        ...
        # @return [Google2::Apis::CustomsearchV1::Context]
        attr_accessor :context
      
        # 
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::CustomsearchV1::Result>]
        attr_accessor :items
        ...
        # @return [Array<Google2::Apis::CustomsearchV1::Promotion>]
        attr_accessor :promotions
      
        # 
        # Corresponds to the JSON property `queries`
        # @return [Hash<String,Array<Google2::Apis::CustomsearchV1::Query>>]
        attr_accessor :queries
      
        # 
        # Corresponds to the JSON property `searchInformation`
        # @return [Google2::Apis::CustomsearchV1::Search::SearchInformation]
        attr_accessor :search_information
      
        # 
        # Corresponds to the JSON property `spelling`
        # @return [Google2::Apis::CustomsearchV1::Search::Spelling]
        attr_accessor :spelling
      
        # 
        # Corresponds to the JSON property `url`
        # @return [Google2::Apis::CustomsearchV1::Search::Url]
        attr_accessor :url
