  ...
  module Apis
    module CustomsearchV1
      ...
      class Context
        ...
        items class: Google2::Apis::CustomsearchV1::Context::Facet, decorator: Google2::Apis::CustomsearchV1::Context::Facet::Representation
      ...
      class Promotion
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          collection :body_lines, as: 'bodyLines', class: Google2::Apis::CustomsearchV1::Promotion::BodyLine, decorator: Google2::Apis::CustomsearchV1::Promotion::BodyLine::Representation
      
          property :display_link, as: 'displayLink'
          property :html_title, as: 'htmlTitle'
          property :image, as: 'image', class: Google2::Apis::CustomsearchV1::Promotion::Image, decorator: Google2::Apis::CustomsearchV1::Promotion::Image::Representation
      ...
      class Result
        ...
        class Representation < Google2::Apis::Core::JsonRepresentation
          ...
          property :html_title, as: 'htmlTitle'
          property :image, as: 'image', class: Google2::Apis::CustomsearchV1::Result::Image, decorator: Google2::Apis::CustomsearchV1::Result::Image::Representation
      
          property :kind, as: 'kind'
          collection :labels, as: 'labels', class: Google2::Apis::CustomsearchV1::Result::Label, decorator: Google2::Apis::CustomsearchV1::Result::Label::Representation
      ...
      class Search
        # @private
        class Representation < Google2::Apis::Core::JsonRepresentation
          property :context, as: 'context', class: Google2::Apis::CustomsearchV1::Context, decorator: Google2::Apis::CustomsearchV1::Context::Representation
      
          collection :items, as: 'items', class: Google2::Apis::CustomsearchV1::Result, decorator: Google2::Apis::CustomsearchV1::Result::Representation
      
          property :kind, as: 'kind'
          collection :promotions, as: 'promotions', class: Google2::Apis::CustomsearchV1::Promotion, decorator: Google2::Apis::CustomsearchV1::Promotion::Representation
      
          hash :queries, as: 'queries', :class => Array do
        include Representable::JSON::Collection
        items class: Google2::Apis::CustomsearchV1::Query, decorator: Google2::Apis::CustomsearchV1::Query::Representation
      
      end
      
          property :search_information, as: 'searchInformation', class: Google2::Apis::CustomsearchV1::Search::SearchInformation, decorator: Google2::Apis::CustomsearchV1::Search::SearchInformation::Representation
      
          property :spelling, as: 'spelling', class: Google2::Apis::CustomsearchV1::Search::Spelling, decorator: Google2::Apis::CustomsearchV1::Search::Spelling::Representation
      
          property :url, as: 'url', class: Google2::Apis::CustomsearchV1::Search::Url, decorator: Google2::Apis::CustomsearchV1::Search::Url::Representation
