...
module Google2
  module Apis
    module ReplicapoolV1beta2
      ...
      #
      # @example
      #    require 'google2/apis/replicapool_v1beta2'
      #
      #    Replicapool = Google2::Apis::ReplicapoolV1beta2 # Alias the module
      #    service = Replicapool::ReplicapoolService.new
      #
      # @see https://developers.google.com/compute/docs/instance-groups/manager/v1beta2
      class ReplicapoolService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::ReplicapoolV1beta2::AbandonInstancesRequest] abandon_instances_request_object
        # @param [String] fields
        ...
        # @yieldparam result [Google2::Apis::ReplicapoolV1beta2::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolV1beta2::Operation]
        #
        ...
        def abandon_instances(project, zone, instance_group_manager, abandon_instances_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolV1beta2::AbandonInstancesRequest::Representation
          command.request_object = abandon_instances_request_object
          command.response_representation = Google2::Apis::ReplicapoolV1beta2::Operation::Representation
          command.response_class = Google2::Apis::ReplicapoolV1beta2::Operation
        ...
        # @param [String] instance_group_manager
        #   The name of the instance group manager.
        # @param [Google2::Apis::ReplicapoolV1beta2::DeleteInstancesRequest] delete_instances_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def delete_instances(project, zone, instance_group_manager, delete_instances_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolV1beta2::DeleteInstancesRequest::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolV1beta2::InstanceGroupManager] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolV1beta2::InstanceGroupManager]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_instance_group_manager(project, zone, instance_group_manager, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolV1beta2::InstanceGroupManager::Representation
          command.response_class = Google2::Apis::ReplicapoolV1beta2::InstanceGroupManager
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.params['instanceGroupManager'] = instance_group_manager unless instance_group_manager.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        # @param [Google2::Apis::ReplicapoolV1beta2::InstanceGroupManager] instance_group_manager_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_instance_group_manager(project, zone, size, instance_group_manager_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolV1beta2::InstanceGroupManager::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolV1beta2::InstanceGroupManagerList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolV1beta2::InstanceGroupManagerList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_instance_group_managers(project, zone, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolV1beta2::InstanceGroupManagerList::Representation
          command.response_class = Google2::Apis::ReplicapoolV1beta2::InstanceGroupManagerList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
        ...
        # @param [String] instance_group_manager
        #   The name of the instance group manager.
        # @param [Google2::Apis::ReplicapoolV1beta2::RecreateInstancesRequest] recreate_instances_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def recreate_instances(project, zone, instance_group_manager, recreate_instances_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolV1beta2::RecreateInstancesRequest::Representation
        ...
        # @param [String] instance_group_manager
        #   The name of the instance group manager.
        # @param [Google2::Apis::ReplicapoolV1beta2::SetInstanceTemplateRequest] set_instance_template_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def set_instance_template(project, zone, instance_group_manager, set_instance_template_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolV1beta2::SetInstanceTemplateRequest::Representation
        ...
        # @param [String] instance_group_manager
        #   The name of the instance group manager.
        # @param [Google2::Apis::ReplicapoolV1beta2::SetTargetPoolsRequest] set_target_pools_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def set_target_pools(project, zone, instance_group_manager, set_target_pools_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ReplicapoolV1beta2::SetTargetPoolsRequest::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::ReplicapoolV1beta2::OperationList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ReplicapoolV1beta2::OperationList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_zone_operations(project, zone, filter: nil, max_results: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::ReplicapoolV1beta2::OperationList::Representation
          command.response_class = Google2::Apis::ReplicapoolV1beta2::OperationList
          command.params['project'] = project unless project.nil?
          command.params['zone'] = zone unless zone.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['maxResults'] = max_results unless max_results.nil?
