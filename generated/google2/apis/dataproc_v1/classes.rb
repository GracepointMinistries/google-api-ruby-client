  ...
  module Apis
    module DataprocV1
      ...
      class Cluster
        ...
        # @return [Google2::Apis::DataprocV1::ClusterConfig]
        attr_accessor :config
      
        # The status of a cluster and its instances.
        # Corresponds to the JSON property `status`
        # @return [Google2::Apis::DataprocV1::ClusterStatus]
        attr_accessor :status
      
        # [Output-only] The previous cluster status.
        # Corresponds to the JSON property `statusHistory`
        # @return [Array<Google2::Apis::DataprocV1::ClusterStatus>]
      ...
      class ClusterConfig
        ...
        # @return [Google2::Apis::DataprocV1::GceClusterConfig]
        ...
        # @return [Google2::Apis::DataprocV1::InstanceGroupConfig]
        ...
        # @return [Google2::Apis::DataprocV1::SoftwareConfig]
        ...
        # @return [Array<Google2::Apis::DataprocV1::NodeInitializationAction>]
      ...
      class InstanceGroupConfig
        ...
        # @return [Google2::Apis::DataprocV1::DiskConfig]
        ...
        # @return [Google2::Apis::DataprocV1::ManagedGroupConfig]
      ...
      class Operation
        ...
        # @return [Google2::Apis::DataprocV1::Status]
        attr_accessor :error
      ...
      class ListClustersResponse
        ...
        # @return [Array<Google2::Apis::DataprocV1::Cluster>]
      ...
      class Job
        ...
        # @return [Google2::Apis::DataprocV1::JobReference]
        attr_accessor :reference
      
        # Cloud Dataproc job config.
        # Corresponds to the JSON property `placement`
        # @return [Google2::Apis::DataprocV1::JobPlacement]
        attr_accessor :placement
      
        # A Cloud Dataproc job for running Hadoop MapReduce jobs on YARN.
        # Corresponds to the JSON property `hadoopJob`
        # @return [Google2::Apis::DataprocV1::HadoopJob]
        ...
        # @return [Google2::Apis::DataprocV1::SparkJob]
      ...
      class HadoopJob
        ...
        # @return [Google2::Apis::DataprocV1::LoggingConfig]
      ...
      class HiveJob
        ...
        # @return [Google2::Apis::DataprocV1::QueryList]
      ...
      class ListJobsResponse
        ...
        # @return [Array<Google2::Apis::DataprocV1::Job>]
        attr_accessor :jobs
      ...
      class ListOperationsResponse
        ...
        # @return [Array<Google2::Apis::DataprocV1::Operation>]
      ...
      class ClusterOperationMetadata
        ...
        # Corresponds to the JSON property `status`
        # @return [Google2::Apis::DataprocV1::ClusterOperationStatus]
        attr_accessor :status
      
        # [Output-only] The previous operation status.
        # Corresponds to the JSON property `statusHistory`
        # @return [Array<Google2::Apis::DataprocV1::ClusterOperationStatus>]
        attr_accessor :status_history
      ...
      class OperationMetadata
        ...
        # The status of the operation.
        # Corresponds to the JSON property `status`
        # @return [Google2::Apis::DataprocV1::OperationStatus]
        attr_accessor :status
      
        # [Output-only] Previous operation status.
        # Corresponds to the JSON property `statusHistory`
        # @return [Array<Google2::Apis::DataprocV1::OperationStatus>]
        attr_accessor :status_history
