...
module Google2
  module Apis
    module ScriptV1
      ...
      #
      # @example
      #    require 'google2/apis/script_v1'
      #
      #    Script = Google2::Apis::ScriptV1 # Alias the module
      #    service = Script::ScriptService.new
      #
      # @see https://developers.google.com/apps-script/execution/rest/v1/scripts/run
      class ScriptService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::ScriptV1::ExecutionRequest] execution_request_object
        # @param [String] fields
        ...
        # @yieldparam result [Google2::Apis::ScriptV1::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::ScriptV1::Operation]
        #
        ...
        def run_script(script_id, execution_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::ScriptV1::ExecutionRequest::Representation
          command.request_object = execution_request_object
          command.response_representation = Google2::Apis::ScriptV1::Operation::Representation
          command.response_class = Google2::Apis::ScriptV1::Operation
