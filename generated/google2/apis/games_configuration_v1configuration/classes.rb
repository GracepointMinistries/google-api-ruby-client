  ...
  module Apis
    module GamesConfigurationV1configuration
      ...
      class AchievementConfiguration
        ...
        # @return [Google2::Apis::GamesConfigurationV1configuration::AchievementConfigurationDetail]
        attr_accessor :draft
      ...
      class AchievementConfigurationDetail
        ...
        # @return [Google2::Apis::GamesConfigurationV1configuration::LocalizedStringBundle]
      ...
      class ListAchievementConfigurationResponse
        ...
        # @return [Array<Google2::Apis::GamesConfigurationV1configuration::AchievementConfiguration>]
        attr_accessor :items
      ...
      class GamesNumberFormatConfiguration
        ...
        # @return [Google2::Apis::GamesConfigurationV1configuration::GamesNumberAffixConfiguration]
      ...
      class LeaderboardConfiguration
        ...
        # Corresponds to the JSON property `draft`
        # @return [Google2::Apis::GamesConfigurationV1configuration::LeaderboardConfigurationDetail]
        attr_accessor :draft
      ...
      class LeaderboardConfigurationDetail
        ...
        # @return [Google2::Apis::GamesConfigurationV1configuration::GamesNumberFormatConfiguration]
      ...
      class ListLeaderboardConfigurationResponse
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::GamesConfigurationV1configuration::LeaderboardConfiguration>]
        attr_accessor :items
      ...
      class LocalizedStringBundle
        ...
        # @return [Array<Google2::Apis::GamesConfigurationV1configuration::LocalizedString>]
