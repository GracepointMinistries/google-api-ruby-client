  ...
  module Apis
    module IamV1
      ...
      class ListServiceAccountsResponse
        ...
        # @return [Array<Google2::Apis::IamV1::ServiceAccount>]
      ...
      class ListServiceAccountKeysResponse
        ...
        # @return [Array<Google2::Apis::IamV1::ServiceAccountKey>]
        attr_accessor :keys
      ...
      class Policy
        ...
        # @return [Array<Google2::Apis::IamV1::Binding>]
        attr_accessor :bindings
      
        # 
        # Corresponds to the JSON property `rules`
        # @return [Array<Google2::Apis::IamV1::Rule>]
        attr_accessor :rules
      ...
      class Rule
        ...
        # @return [Array<Google2::Apis::IamV1::Condition>]
        attr_accessor :conditions
      
        # The config returned to callers of tech.iam.IAM.CheckPolicy for any entries
        # that match the LOG action.
        # Corresponds to the JSON property `logConfig`
        # @return [Array<Google2::Apis::IamV1::LogConfig>]
      ...
      class LogConfig
        ...
        # @return [Google2::Apis::IamV1::CounterOptions]
        attr_accessor :counter
      
        # Write a Data Access (Gin) log
        # Corresponds to the JSON property `dataAccess`
        # @return [Google2::Apis::IamV1::DataAccessOptions]
        attr_accessor :data_access
      
        # Write a Cloud Audit log
        # Corresponds to the JSON property `cloudAudit`
        # @return [Google2::Apis::IamV1::CloudAuditOptions]
