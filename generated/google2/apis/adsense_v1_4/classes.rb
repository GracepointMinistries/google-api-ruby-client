  ...
  module Apis
    module AdsenseV1_4
      ...
      class Account
        ...
        # @return [Array<Google2::Apis::AdsenseV1_4::Account>]
      ...
      class AdClients
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::AdClient>]
        attr_accessor :items
      ...
      class AdStyle
        ...
        # @return [Google2::Apis::AdsenseV1_4::AdStyle::Colors]
        ...
        # @return [Google2::Apis::AdsenseV1_4::AdStyle::Font]
        attr_accessor :font
      ...
      class AdUnit
        ...
        # @return [Google2::Apis::AdsenseV1_4::AdUnit::MobileContentAdsSettings]
        ...
        class ContentAdsSettings
          ...
          # @return [Google2::Apis::AdsenseV1_4::AdUnit::ContentAdsSettings::BackupOption]
      ...
      class AdUnits
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::AdUnit>]
        attr_accessor :items
      ...
      class GenerateReportResponse
        ...
        # @return [Array<Google2::Apis::AdsenseV1_4::GenerateReportResponse::Header>]
      ...
      class Alerts
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::Alert>]
        attr_accessor :items
      ...
      class CustomChannel
        ...
        # @return [Google2::Apis::AdsenseV1_4::CustomChannel::TargetingInfo]
      ...
      class CustomChannels
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::CustomChannel>]
        attr_accessor :items
      ...
      class Metadata
        ...
        # 
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::ReportingMetadataEntry>]
        attr_accessor :items
      ...
      class Payments
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::Payment>]
        attr_accessor :items
      ...
      class SavedAdStyles
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::SavedAdStyle>]
        attr_accessor :items
      ...
      class SavedReports
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::SavedReport>]
        attr_accessor :items
      ...
      class UrlChannels
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google2::Apis::AdsenseV1_4::UrlChannel>]
        attr_accessor :items
