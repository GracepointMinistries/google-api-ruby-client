...
module Google2
  module Apis
    module YoutubePartnerV1
      ...
      #
      # @example
      #    require 'google2/apis/youtube_partner_v1'
      #
      #    YoutubePartner = Google2::Apis::YoutubePartnerV1 # Alias the module
      #    service = YoutubePartner::YouTubePartnerService.new
      #
      # @see https://developers.google.com/youtube/partner/
      class YouTubePartnerService < Google2::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [Google2::Apis::YoutubePartnerV1::AssetLabel] asset_label_object
        ...
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetLabel] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetLabel]
        #
        ...
        def insert_asset_label(asset_label_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::AssetLabel::Representation
          command.request_object = asset_label_object
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetLabel::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetLabel
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetLabelListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetLabelListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_asset_labels(label_prefix: nil, on_behalf_of_content_owner: nil, q: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetLabelListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetLabelListResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetMatchPolicy] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetMatchPolicy]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_asset_match_policy(asset_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetMatchPolicy::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetMatchPolicy
        ...
        #   The assetId parameter specifies the YouTube asset ID of the asset for which
        #   you are retrieving the match policy.
        # @param [Google2::Apis::YoutubePartnerV1::AssetMatchPolicy] asset_match_policy_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def patch_asset_match_policy(asset_id, asset_match_policy_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::AssetMatchPolicy::Representation
        ...
        # @param [Google2::Apis::YoutubePartnerV1::AssetRelationship] asset_relationship_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetRelationship] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetRelationship]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def insert_asset_relationship(asset_relationship_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::AssetRelationship::Representation
          command.request_object = asset_relationship_object
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetRelationship::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetRelationship
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetRelationshipListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetRelationshipListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_asset_relationships(asset_id, on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetRelationshipListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetRelationshipListResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetSearchResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetSearchResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_asset_searches(created_after: nil, created_before: nil, has_conflicts: nil, include_any_providedlabel: nil, isrcs: nil, labels: nil, metadata_search_fields: nil, on_behalf_of_content_owner: nil, ownership_restriction: nil, page_token: nil, q: nil, sort: nil, type: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetSearchResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetSearchResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Asset] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Asset]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_asset(asset_id, fetch_match_policy: nil, fetch_metadata: nil, fetch_ownership: nil, fetch_ownership_conflicts: nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Asset::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Asset
          command.params['assetId'] = asset_id unless asset_id.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::Asset] asset_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def insert_asset(asset_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Asset::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::AssetListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::AssetListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_assets(id, fetch_match_policy: nil, fetch_metadata: nil, fetch_ownership: nil, fetch_ownership_conflicts: nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::AssetListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::AssetListResponse
          command.query['fetchMatchPolicy'] = fetch_match_policy unless fetch_match_policy.nil?
          command.query['fetchMetadata'] = fetch_metadata unless fetch_metadata.nil?
          command.query['fetchOwnership'] = fetch_ownership unless fetch_ownership.nil?
          command.query['fetchOwnershipConflicts'] = fetch_ownership_conflicts unless fetch_ownership_conflicts.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Campaign] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Campaign]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_campaign(campaign_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Campaign::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Campaign
          command.params['campaignId'] = campaign_id unless campaign_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::Campaign] campaign_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def insert_campaign(campaign_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Campaign::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::CampaignList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::CampaignList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_campaigns(on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::CampaignList::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::CampaignList
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ClaimHistory] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ClaimHistory]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_claim_history(claim_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ClaimHistory::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ClaimHistory
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ClaimSearchResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ClaimSearchResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_claim_searches(asset_id: nil, content_type: nil, created_after: nil, created_before: nil, inactive_reasons: nil, include_third_party_claims: nil, on_behalf_of_content_owner: nil, origin: nil, page_token: nil, partner_uploaded: nil, q: nil, reference_id: nil, sort: nil, status: nil, video_id: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ClaimSearchResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ClaimSearchResponse
          command.query['assetId'] = asset_id unless asset_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Claim] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Claim]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_claim(claim_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Claim::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Claim
          command.params['claimId'] = claim_id unless claim_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::Claim] claim_object
        ...
        def insert_claim(claim_object = nil, is_manual_claim: nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Claim::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ClaimListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ClaimListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_claims(asset_id: nil, id: nil, on_behalf_of_content_owner: nil, page_token: nil, q: nil, video_id: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ClaimListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ClaimListResponse
          command.query['assetId'] = asset_id unless asset_id.nil?
          command.query['id'] = id unless id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ContentOwnerAdvertisingOption] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ContentOwnerAdvertisingOption]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_content_owner_advertising_option(on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ContentOwnerAdvertisingOption::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ContentOwnerAdvertisingOption
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::ContentOwnerAdvertisingOption] content_owner_advertising_option_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def patch_content_owner_advertising_option(content_owner_advertising_option_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::ContentOwnerAdvertisingOption::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ContentOwner] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ContentOwner]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_content_owner(content_owner_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ContentOwner::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ContentOwner
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ContentOwnerListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ContentOwnerListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_content_owners(fetch_mine: nil, id: nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ContentOwnerListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ContentOwnerListResponse
        ...
        # @param [Google2::Apis::YoutubePartnerV1::LiveCuepoint] live_cuepoint_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::LiveCuepoint] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::LiveCuepoint]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def insert_live_cuepoint(channel_id, live_cuepoint_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::LiveCuepoint::Representation
          command.request_object = live_cuepoint_object
          command.response_representation = Google2::Apis::YoutubePartnerV1::LiveCuepoint::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::LiveCuepoint
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::MetadataHistoryListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::MetadataHistoryListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_metadata_histories(asset_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::MetadataHistoryListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::MetadataHistoryListResponse
          command.query['assetId'] = asset_id unless asset_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Order] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Order]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_order(order_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Order::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Order
          command.params['orderId'] = order_id unless order_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::Order] order_object
        # @param [String] on_behalf_of_content_owner
        #   ContentOnwerId that super admin acts in behalf of.
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        ...
        def insert_order(order_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Order::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::OrderListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::OrderListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_orders(channel_id: nil, content_type: nil, country: nil, custom_id: nil, on_behalf_of_content_owner: nil, page_token: nil, priority: nil, production_house: nil, q: nil, status: nil, video_id: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::OrderListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::OrderListResponse
          command.query['channelId'] = channel_id unless channel_id.nil?
          command.query['contentType'] = content_type unless content_type.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::RightsOwnership] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::RightsOwnership]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_ownership(asset_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::RightsOwnership::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::RightsOwnership
          command.params['assetId'] = asset_id unless asset_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #   The assetId parameter specifies the YouTube asset ID of the asset being
        #   updated.
        # @param [Google2::Apis::YoutubePartnerV1::RightsOwnership] rights_ownership_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def patch_ownership(asset_id, rights_ownership_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::RightsOwnership::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::OwnershipHistoryListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::OwnershipHistoryListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_ownership_histories(asset_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::OwnershipHistoryListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::OwnershipHistoryListResponse
          command.query['assetId'] = asset_id unless asset_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Policy] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Policy]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_policy(policy_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Policy::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Policy
        ...
        # @param [Google2::Apis::YoutubePartnerV1::Policy] policy_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def insert_policy(policy_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Policy::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::PolicyList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::PolicyList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_policies(id: nil, on_behalf_of_content_owner: nil, sort: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::PolicyList::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::PolicyList
          command.query['id'] = id unless id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['sort'] = sort unless sort.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Publisher] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Publisher]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_publisher(publisher_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Publisher::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Publisher
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::PublisherList] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::PublisherList]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_publishers(cae_number: nil, id: nil, ipi_number: nil, max_results: nil, name_prefix: nil, on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::PublisherList::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::PublisherList
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ReferenceConflict] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ReferenceConflict]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_reference_conflict(reference_conflict_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ReferenceConflict::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ReferenceConflict
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ReferenceConflictListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ReferenceConflictListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_reference_conflicts(on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ReferenceConflictListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ReferenceConflictListResponse
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Reference] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Reference]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_reference(reference_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Reference::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Reference
        ...
        # @param [Google2::Apis::YoutubePartnerV1::Reference] reference_object
        # @param [String] claim_id
        ...
        def insert_reference(reference_object = nil, claim_id: nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, upload_source: nil, content_type: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Reference::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ReferenceListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ReferenceListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_references(asset_id: nil, id: nil, on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::ReferenceListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ReferenceListResponse
          command.query['assetId'] = asset_id unless asset_id.nil?
          command.query['id'] = id unless id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::ValidateRequest] validate_request_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::ValidateResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::ValidateResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def validate_validator(validate_request_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::ValidateRequest::Representation
          command.request_object = validate_request_object
          command.response_representation = Google2::Apis::YoutubePartnerV1::ValidateResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::ValidateResponse
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::VideoAdvertisingOption] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::VideoAdvertisingOption]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_video_advertising_option(video_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::VideoAdvertisingOption::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::VideoAdvertisingOption
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::VideoAdvertisingOptionGetEnabledAdsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::VideoAdvertisingOptionGetEnabledAdsResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_video_advertising_option_enabled_ads(video_id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::VideoAdvertisingOptionGetEnabledAdsResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::VideoAdvertisingOptionGetEnabledAdsResponse
          command.params['videoId'] = video_id unless video_id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [Google2::Apis::YoutubePartnerV1::VideoAdvertisingOption] video_advertising_option_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def patch_video_advertising_option(video_id, video_advertising_option_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::VideoAdvertisingOption::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::Whitelist] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::Whitelist]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def get_whitelist(id, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::Whitelist::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::Whitelist
          command.params['id'] = id unless id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # channels.
        # @param [Google2::Apis::YoutubePartnerV1::Whitelist] whitelist_object
        # @param [String] on_behalf_of_content_owner
        #   The onBehalfOfContentOwner parameter identifies the content owner that the
        #   user is acting on behalf of. This parameter supports users whose accounts are
        #   associated with multiple content owners.
        ...
        def insert_whitelist(whitelist_object = nil, on_behalf_of_content_owner: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = Google2::Apis::YoutubePartnerV1::Whitelist::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google2::Apis::YoutubePartnerV1::WhitelistListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google2::Apis::YoutubePartnerV1::WhitelistListResponse]
        #
        # @raise [Google2::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google2::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google2::Apis::AuthorizationError] Authorization is required
        def list_whitelists(id: nil, on_behalf_of_content_owner: nil, page_token: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = Google2::Apis::YoutubePartnerV1::WhitelistListResponse::Representation
          command.response_class = Google2::Apis::YoutubePartnerV1::WhitelistListResponse
          command.query['id'] = id unless id.nil?
          command.query['onBehalfOfContentOwner'] = on_behalf_of_content_owner unless on_behalf_of_content_owner.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
