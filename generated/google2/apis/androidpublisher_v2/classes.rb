  ...
  module Apis
    module AndroidpublisherV2
      ...
      class Apk
        ...
        # @return [Google2::Apis::AndroidpublisherV2::ApkBinary]
      ...
      class ListApkListingsResponse
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::ApkListing>]
      ...
      class ApksAddExternallyHostedRequest
        ...
        # @return [Google2::Apis::AndroidpublisherV2::ExternallyHostedApk]
      ...
      class ListApksResponse
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::Apk>]
        attr_accessor :apks
      ...
      class Comment
        ...
        # @return [Google2::Apis::AndroidpublisherV2::DeveloperComment]
        attr_accessor :developer_comment
      
        # A comment from a user.
        # Corresponds to the JSON property `userComment`
        # @return [Google2::Apis::AndroidpublisherV2::UserComment]
      ...
      class DeveloperComment
        ...
        # @return [Google2::Apis::AndroidpublisherV2::Timestamp]
      ...
      class ListEntitlementsResponse
        ...
        # @return [Google2::Apis::AndroidpublisherV2::PageInfo]
        attr_accessor :page_info
      
        # 
        # Corresponds to the JSON property `resources`
        # @return [Array<Google2::Apis::AndroidpublisherV2::Entitlement>]
        attr_accessor :resources
      
        # 
        # Corresponds to the JSON property `tokenPagination`
        # @return [Google2::Apis::AndroidpublisherV2::TokenPagination]
      ...
      class ExternallyHostedApk
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::ExternallyHostedApkUsesPermission>]
      ...
      class DeleteAllImagesResponse
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::Image>]
      ...
      class UploadImagesResponse
        ...
        # @return [Google2::Apis::AndroidpublisherV2::Image]
        attr_accessor :image
      ...
      class InAppProduct
        ...
        # @return [Google2::Apis::AndroidpublisherV2::Price]
        attr_accessor :default_price
      
        # List of localized title and description data.
        # Corresponds to the JSON property `listings`
        # @return [Hash<String,Google2::Apis::AndroidpublisherV2::InAppProductListing>]
        attr_accessor :listings
        ...
        # @return [Hash<String,Google2::Apis::AndroidpublisherV2::Price>]
        ...
        # @return [Google2::Apis::AndroidpublisherV2::Season]
      ...
      class InAppProductsBatchRequest
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::InAppProductsBatchRequestEntry>]
      ...
      class InAppProductsBatchRequestEntry
        ...
        # @return [Google2::Apis::AndroidpublisherV2::InsertInAppProductsRequest]
        attr_accessor :inappproductsinsertrequest
      
        # 
        # Corresponds to the JSON property `inappproductsupdaterequest`
        # @return [Google2::Apis::AndroidpublisherV2::UpdateInAppProductsRequest]
      ...
      class InAppProductsBatchResponse
        ...
        # 
        # Corresponds to the JSON property `entrys`
        # @return [Array<Google2::Apis::AndroidpublisherV2::InAppProductsBatchResponseEntry>]
        attr_accessor :entrys
      ...
      class InAppProductsBatchResponseEntry
        ...
        # @return [Google2::Apis::AndroidpublisherV2::InsertInAppProductsResponse]
        attr_accessor :inappproductsinsertresponse
      
        # 
        # Corresponds to the JSON property `inappproductsupdateresponse`
        # @return [Google2::Apis::AndroidpublisherV2::UpdateInAppProductsResponse]
      ...
      class ListInAppProductsResponse
        ...
        # 
        # Corresponds to the JSON property `inappproduct`
        # @return [Array<Google2::Apis::AndroidpublisherV2::InAppProduct>]
        attr_accessor :inappproduct
      ...
      class ListListingsResponse
        ...
        # 
        # Corresponds to the JSON property `listings`
        # @return [Array<Google2::Apis::AndroidpublisherV2::Listing>]
        attr_accessor :listings
      ...
      class Prorate
        ...
        # @return [Google2::Apis::AndroidpublisherV2::MonthDay]
        attr_accessor :start
      ...
      class Review
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::Comment>]
      ...
      class ReviewsListResponse
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::Review>]
      ...
      class ReviewsReplyResponse
        ...
        # @return [Google2::Apis::AndroidpublisherV2::ReviewReplyResult]
      ...
      class Season
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::Prorate>]
      ...
      class DeferSubscriptionPurchasesRequest
        ...
        # @return [Google2::Apis::AndroidpublisherV2::SubscriptionDeferralInfo]
      ...
      class ListTracksResponse
        ...
        # @return [Array<Google2::Apis::AndroidpublisherV2::Track>]
